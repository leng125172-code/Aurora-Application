...
typedef enum
{
	...
	TUIDI_USB_HAS_XML,							   // the USB has xml
...
typedef enum
{
	...
	TUIDC_ENABLELOWPOWER		= 0x4A,             // id capability low-power enable
	TUIDC_ENABLEEXPPOLL         = 0x4B,             // id capability exposure polling enable
	TUIDC_NUMEXPPOLL            = 0x4C,             // id capability exposure polling number
	TUIDC_SELEXPPOLL            = 0x4D,             // id capability exposure polling select
    TUIDC_ENDCAPABILITY         = 0x4E,             // id capability end 
}TUCAM_IDCAPA;
...
{   
	...
	TUIDP_EXPPOLLTIME           = 0x2D,             // id property exposure polling time

	TUIDP_ENDPROPERTY           = 0x2E,             // id property end 
}TUCAM_IDPROP;
...
typedef enum 
{
	...
	TUFW_XML					= 0x04,             // The type firmware XML
}TUFW_TYPE;
