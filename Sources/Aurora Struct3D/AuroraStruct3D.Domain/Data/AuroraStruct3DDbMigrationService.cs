...
{
    public class AuroraStruct3DDbMigrationService : ITransientDependency
    {
        public ILogger<AuroraStruct3DDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IAuroraStruct3DDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public AuroraStruct3DDbMigrationService(
        ...
        )
        {
            ...
            Logger = NullLogger<AuroraStruct3DDbMigrationService>.Instance;
        }
