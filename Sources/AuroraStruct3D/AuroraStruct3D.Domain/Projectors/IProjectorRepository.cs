...
public interface IProjectorDeviceRepository : IRepository<ProjectorDevice, Guid>
{
    ...
    /// <summary>
    /// 根据 HID 设备索引查找投影仪设备（USB HID 模式，VID/PID 由硬件固定）
    /// </summary>
...
{
    /// <summary>
    /// 获取指定投影仪的操作日志分页列表，按时间倒序
    /// </summary>
    /// <param name="projectorDeviceId">投影仪设备 ID</param>
