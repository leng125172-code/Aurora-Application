...
/// <summary>
/// 投影仪实时状态推送 SignalR Hub。
/// 允许匿名访问，客户端连接后立即收到全部投影仪的当前状态快照。
/// </summary>
[AllowAnonymous]
[DisableAutoHubMap]
public class ProjectorHub : AbpHub<IProjectorHub>
{
    ...
    /// <summary>客户端连接时，立即推送全部投影仪状态快照</summary>
    public override async Task OnConnectedAsync()
    {
        await base.OnConnectedAsync();

        // 查询全部投影仪并逐一推送给当前连接的客户端
    ...
    /// <summary>
    /// 向所有客户端广播某台投影仪的最新状态（供 AppService 层注入 Hub 后调用）
    /// </summary>
