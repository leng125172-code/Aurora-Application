...
<style scoped>
.role-checkbox-group :deep(.ant-checkbox-group) {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
}

.role-checkbox-group :deep(.ant-checkbox-wrapper) {
