...
export const CreateMasterDataAttributeInputSchema = {
    required: ['attributeType', 'code', 'masterDataTypeId', 'name'],
    type: 'object',
    properties: {
        masterDataTypeId: {
            type: 'string',
        ...
        attributeType: {
            minLength: 1,
            type: 'string',
            description: '属性类型(string,date,long等)'
        }
    },
    additionalProperties: false,
    description: '创建主数据属性输入参数'
} as const;

export const CreateMasterDataInputSchema = {
    required: ['code', 'masterDataTypeCode', 'name'],
    type: 'object',
    properties: {
        masterDataTypeCode: {
            minLength: 1,
        ...
        attributes: {
            ...
            description: '属性值字典，键为属性编码，值为属性值',
            nullable: true
        }
    },
    additionalProperties: false,
    description: '创建主数据输入参数'
} as const;

export const CreateMasterDataTypeInputSchema = {
    type: 'object',
    properties: {
        name: {
            type: 'string',
...
export const DataDictionaryDetailDtoSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
...
export const DataDictionaryDtoSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
        ...
        details: {
            type: 'array',
            items: {
                '$ref': '#/components/schemas/DataDictionaryDetailDto'
            },
            description: '字典明细集合',
            nullable: true
        }
...
export const DeleteMasterDataAttributeInputSchema = {
    required: ['id'],
    type: 'object',
    properties: {
        id: {
    ...
    additionalProperties: false,
    description: '删除主数据属性输入参数'
} as const;

export const DeleteMasterDataTypeInputSchema = {
    required: ['id'],
    type: 'object',
    properties: {
        id: {
...
export const DownloadTemplateInputSchema = {
...
export const FileMetadataOptionsSchema = {
    type: 'object',
    properties: {
        currentCulture: {
            type: 'string',
...
export const FindByCodeInputSchema = {
    required: ['code'],
    type: 'object',
    properties: {
        code: {
...
export const GetCacheKeysInputSchema = {
    type: 'object',
    properties: {
        key: {
            type: 'string',
...
export const GetCacheKeysOutputSchema = {
    type: 'object',
    properties: {
        key: {
            type: 'string',
...
export const GetCacheKeysOutputPagedResultDtoSchema = {
    type: 'object',
    properties: {
        items: {
            type: 'array',
            items: {
                '$ref': '#/components/schemas/GetCacheKeysOutput'
            },
            nullable: true
        },
        totalCount: {
...
export const GetCacheValueInputSchema = {
    required: ['key'],
    type: 'object',
    properties: {
        key: {
...
export const GetCacheValueOutputSchema = {
    type: 'object',
    properties: {
        type: {
            type: 'string',
...
export const GetImportExcelContributorOutputSchema = {
    type: 'object',
    properties: {
        name: {
            type: 'string',
...
export const GetMasterDataAttributeOutputSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
    ...
    additionalProperties: false,
    description: '主数据属性输出参数'
} as const;

export const GetMasterDataAttributesInputSchema = {
    type: 'object',
    properties: {
        masterDataTypeId: {
            type: 'string',
    ...
    additionalProperties: false,
    description: '获取主数据属性输入参数'
} as const;

export const GetMasterDataInfoAttributeOutputSchema = {
    type: 'object',
    properties: {
        value: {
            type: 'string',
    ...
    additionalProperties: false,
    description: '主数据信息属性输出参数'
} as const;

export const GetMasterDataInfoInputSchema = {
    type: 'object',
    properties: {
        pageIndex: {
            type: 'integer',
...
<example>
 name desc
        ...
        masterDataCode: {
            type: 'string',
            description: '主数据编码（可选）',
            nullable: true
        }
    },
    additionalProperties: false,
    description: '获取主数据信息输入参数'
} as const;

export const GetMasterDataInfoOutputSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
        ...
        attributes: {
            type: 'array',
            items: {
                '$ref': '#/components/schemas/GetMasterDataInfoAttributeOutput'
            },
            description: '主数据属性列表',
            nullable: true
        }
    ...
    additionalProperties: false,
    description: '主数据信息输出参数'
} as const;

export const GetMasterDataInfoOutputPagedResultDtoSchema = {
    type: 'object',
    properties: {
        items: {
            type: 'array',
            items: {
                '$ref': '#/components/schemas/GetMasterDataInfoOutput'
            },
            nullable: true
        },
        totalCount: {
...
export const ImportStatusSchema = {
    ...
    type: 'integer',
    format: 'int32',
    'x-enumNames': ['Running', 'Success', 'Failed', 'Exception'],
    'x-enum-varnames': ['Running', 'Success', 'Failed', 'Exception']
} as const;
...
export const MasterDataTypeOutputSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
...
export const PageImportRecordInputSchema = {
    type: 'object',
    properties: {
        pageIndex: {
            type: 'integer',
...
export const PageImportRecordOutputSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
...
export const PageImportRecordOutputPagedResultDtoSchema = {
    type: 'object',
    properties: {
        items: {
            type: 'array',
            items: {
                '$ref': '#/components/schemas/PageImportRecordOutput'
            },
            nullable: true
        },
        totalCount: {
...
export const PageOnlineUserOutputSchema = {
    type: 'object',
    properties: {
        connectionId: {
            type: 'string',
...
export const PageOnlineUserOutputPagedResultDtoSchema = {
    type: 'object',
    properties: {
        items: {
            type: 'array',
            items: {
                '$ref': '#/components/schemas/PageOnlineUserOutput'
            },
            nullable: true
        },
        totalCount: {
...
export const PagingOnlineUserInputSchema = {
    type: 'object',
    properties: {
        pageIndex: {
            type: 'integer',
...
export const RemoveCacheInputSchema = {
    required: ['key'],
    type: 'object',
    properties: {
        key: {
...
export const SetMasterDataEnabledInputSchema = {
    required: ['id'],
    type: 'object',
    properties: {
        id: {
...
export const UpdateMasterDataAttributeInputSchema = {
    required: ['attributeType', 'code', 'id', 'masterDataTypeId', 'name'],
    type: 'object',
    properties: {
        id: {
            type: 'string',
    ...
    additionalProperties: false,
    description: '更新主数据属性输入参数'
} as const;

export const UpdateMasterDataInputSchema = {
    required: ['code', 'id', 'masterDataCode', 'masterDataTypeCode', 'name'],
    type: 'object',
    properties: {
        masterDataCode: {
            type: 'string',
    ...
    additionalProperties: false,
    description: '更新主数据输入参数'
} as const;

export const UpdateMasterDataTypeInputSchema = {
