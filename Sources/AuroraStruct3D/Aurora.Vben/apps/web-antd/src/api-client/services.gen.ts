 ...
 * 获取缓存keys
 */
export const postCachesKeys = <ThrowOnError extends boolean = false>(options?: Options<PostCachesKeysData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostCachesKeysResponse, PostCachesKeysError, ThrowOnError>({
        ...options,
        url: '/Caches/keys'
    });
};
 ...
 * 获取缓存value
 */
export const postCachesValue = <ThrowOnError extends boolean = false>(options?: Options<PostCachesValueData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostCachesValueResponse, PostCachesValueError, ThrowOnError>({
        ...options,
        url: '/Caches/value'
    });
};
 ...
 * 删除缓存
 */
export const postCachesRemove = <ThrowOnError extends boolean = false>(options?: Options<PostCachesRemoveData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostCachesRemoveResponse, PostCachesRemoveError, ThrowOnError>({
        ...options,
        url: '/Caches/remove'
    });
};
 ...
 * 通过code查询字典信息
 */
export const postDataDictionaryFindByCode = <ThrowOnError extends boolean = false>(options?: Options<PostDataDictionaryFindByCodeData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostDataDictionaryFindByCodeResponse, PostDataDictionaryFindByCodeError, ThrowOnError>({
        ...options,
        url: '/DataDictionary/findByCode'
    });
};
 ...
 * 上传文件
 */
export const putFilesUpload = <ThrowOnError extends boolean = false>(options?: Options<PutFilesUploadData, ThrowOnError>) => {
    return (options?.client ?? client).put<PutFilesUploadResponse, PutFilesUploadError, ThrowOnError>({
        ...options,
 ...
 * 下载文件
 */
export const putFilesDownload = <ThrowOnError extends boolean = false>(options?: Options<PutFilesDownloadData, ThrowOnError>) => {
    return (options?.client ?? client).put<PutFilesDownloadResponse, PutFilesDownloadError, ThrowOnError>({
        ...options,
        url: '/Files/Download'
    });
};
 ...
 * 分页查询导入记录
 */
export const postImportRecordsPage = <ThrowOnError extends boolean = false>(options?: Options<PostImportRecordsPageData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostImportRecordsPageResponse, PostImportRecordsPageError, ThrowOnError>({
        ...options,
        url: '/ImportRecords/Page'
    });
};
 ...
 * 获取导入excel贡献者
 */
export const postImportRecordsImportExcelContributor = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).post<PostImportRecordsImportExcelContributorResponse, PostImportRecordsImportExcelContributorError, ThrowOnError>({
        ...options,
        url: '/ImportRecords/ImportExcel/Contributor'
    });
};
 ...
 * 获取导入类型
 */
export const postImportRecordsGet = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).post<PostImportRecordsGetResponse, PostImportRecordsGetError, ThrowOnError>({
        ...options,
        url: '/ImportRecords/Get'
    });
};
 ...
 * 导入Excel
 */
export const putImportRecordsImportExcel = <ThrowOnError extends boolean = false>(options?: Options<PutImportRecordsImportExcelData, ThrowOnError>) => {
    return (options?.client ?? client).put<PutImportRecordsImportExcelResponse, PutImportRecordsImportExcelError, ThrowOnError>({
        ...options,
        ...formDataBodySerializer,
        headers: {
            'Content-Type': null,
        ...
        url: '/ImportRecords/Import/Excel'
    });
};
 ...
 * 下载导入模板
 */
export const putImportRecordsDownloadExcelTemplate = <ThrowOnError extends boolean = false>(options?: Options<PutImportRecordsDownloadExcelTemplateData, ThrowOnError>) => {
    return (options?.client ?? client).put<PutImportRecordsDownloadExcelTemplateResponse, PutImportRecordsDownloadExcelTemplateError, ThrowOnError>({
        ...options,
        url: '/ImportRecords/Download/Excel/Template'
    });
};
 ...
 * 获取所有主数据类型
 */
export const postMasterDataGetMasterDataTypes = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataGetMasterDataTypesResponse, PostMasterDataGetMasterDataTypesError, ThrowOnError>({
        ...options,
        url: '/MasterData/GetMasterDataTypes'
    });
};
 ...
 * 创建主数据类型
 */
export const postMasterDataCreateMasterDataType = <ThrowOnError extends boolean = false>(options?: Options<PostMasterDataCreateMasterDataTypeData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataCreateMasterDataTypeResponse, PostMasterDataCreateMasterDataTypeError, ThrowOnError>({
        ...options,
        url: '/MasterData/CreateMasterDataType'
    });
};
 ...
 * 更新主数据类型
 */
export const postMasterDataUpdateMasterDataType = <ThrowOnError extends boolean = false>(options?: Options<PostMasterDataUpdateMasterDataTypeData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataUpdateMasterDataTypeResponse, PostMasterDataUpdateMasterDataTypeError, ThrowOnError>({
        ...options,
        url: '/MasterData/UpdateMasterDataType'
    });
};
 ...
 * 根据编码删除主数据类型
 */
export const postMasterDataDeleteMasterDataType = <ThrowOnError extends boolean = false>(options?: Options<PostMasterDataDeleteMasterDataTypeData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataDeleteMasterDataTypeResponse, PostMasterDataDeleteMasterDataTypeError, ThrowOnError>({
        ...options,
        url: '/MasterData/DeleteMasterDataType'
    });
};
 ...
 * 获取主数据属性列表
 */
export const postMasterDataGetMasterDataAttributes = <ThrowOnError extends boolean = false>(options?: Options<PostMasterDataGetMasterDataAttributesData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataGetMasterDataAttributesResponse, PostMasterDataGetMasterDataAttributesError, ThrowOnError>({
        ...options,
        url: '/MasterData/GetMasterDataAttributes'
    });
};
 ...
 * 创建主数据属性
 */
export const postMasterDataCreateMasterDataAttribute = <ThrowOnError extends boolean = false>(options?: Options<PostMasterDataCreateMasterDataAttributeData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataCreateMasterDataAttributeResponse, PostMasterDataCreateMasterDataAttributeError, ThrowOnError>({
        ...options,
        url: '/MasterData/CreateMasterDataAttribute'
    });
};
 ...
 * 更新主数据属性
 */
export const postMasterDataUpdateMasterDataAttribute = <ThrowOnError extends boolean = false>(options?: Options<PostMasterDataUpdateMasterDataAttributeData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataUpdateMasterDataAttributeResponse, PostMasterDataUpdateMasterDataAttributeError, ThrowOnError>({
        ...options,
        url: '/MasterData/UpdateMasterDataAttribute'
    });
};
 ...
 * 删除主数据属性
 */
export const postMasterDataDeleteMasterDataAttribute = <ThrowOnError extends boolean = false>(options?: Options<PostMasterDataDeleteMasterDataAttributeData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataDeleteMasterDataAttributeResponse, PostMasterDataDeleteMasterDataAttributeError, ThrowOnError>({
        ...options,
        url: '/MasterData/DeleteMasterDataAttribute'
    });
};
 ...
 * 获取主数据信息
 */
export const postMasterDataGetMasterDataInfo = <ThrowOnError extends boolean = false>(options?: Options<PostMasterDataGetMasterDataInfoData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataGetMasterDataInfoResponse, PostMasterDataGetMasterDataInfoError, ThrowOnError>({
        ...options,
        url: '/MasterData/GetMasterDataInfo'
    });
};
 ...
 * 创建主数据
 */
export const postMasterDataCreateMasterData = <ThrowOnError extends boolean = false>(options?: Options<PostMasterDataCreateMasterDataData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataCreateMasterDataResponse, PostMasterDataCreateMasterDataError, ThrowOnError>({
        ...options,
 ...
 * 更新主数据
 */
export const postMasterDataUpdateMasterData = <ThrowOnError extends boolean = false>(options?: Options<PostMasterDataUpdateMasterDataData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataUpdateMasterDataResponse, PostMasterDataUpdateMasterDataError, ThrowOnError>({
        ...options,
 ...
 * 设置主数据启用/禁用状态
 */
export const postMasterDataSetMasterDataStatus = <ThrowOnError extends boolean = false>(options?: Options<PostMasterDataSetMasterDataStatusData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostMasterDataSetMasterDataStatusResponse, PostMasterDataSetMasterDataStatusError, ThrowOnError>({
        ...options,
        url: '/MasterData/SetMasterDataStatus'
    });
};
 ...
 * 分页获取在线用户
 */
export const postOnlinePage = <ThrowOnError extends boolean = false>(options?: Options<PostOnlinePageData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostOnlinePageResponse, PostOnlinePageError, ThrowOnError>({
        ...options,
        url: '/Online/Page'
    });
};
 ...
 * 强制下线用户
 */
export const postOnlineForceOut = <ThrowOnError extends boolean = false>(options?: Options<PostOnlineForceOutData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostOnlineForceOutResponse, PostOnlineForceOutError, ThrowOnError>({
        ...options,
        url: '/Online/ForceOut'
    });
};
