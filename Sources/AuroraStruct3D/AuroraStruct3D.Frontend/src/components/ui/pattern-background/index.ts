...
export const patternBackgroundMaskVariants = cva('bg-default bg-background', {
    variants: {
        mask: {
            [PATTERN_BACKGROUND_MASK.Ellipse]: 'mask-[radial-gradient(ellipse_at_center,transparent_20%,black)]',
            [PATTERN_BACKGROUND_MASK.EllipseTop]: 'mask-[radial-gradient(ellipse_at_top,transparent_20%,black)]',
        },
    },
    defaultVariants: {
        mask: 'ellipse',
