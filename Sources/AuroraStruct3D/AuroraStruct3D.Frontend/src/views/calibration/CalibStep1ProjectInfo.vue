        ...
        <div v-else-if="props.project" class="flex flex-col flex-1 min-h-0">
            ...
            <div class="flex gap-6 flex-1 pt-5">
                ...
                <div class="flex-1 flex items-center justify-center min-w-0 min-h-0 self-stretch">
                    ...
                    <svg
                        v-else-if="props.project.deviceType === CalibDeviceType.ThreeCamera0Light"
                        viewBox="0 0 400 280"
                        class="w-full max-h-72 object-contain"
                        aria-label="3目0光设备布局"
                    >
                        ...
                        <text x="200" y="22" text-anchor="middle" font-size="11" fill="currentColor" opacity="0.85">
                            主相机（中上）
                        </text>
                        <rect
                            x="48"
                        ...
                        <text x="88" y="248" text-anchor="middle" font-size="11" fill="currentColor" opacity="0.85">
                            左下相机
                        </text>
                        <rect
                            x="272"
                        ...
                        <text x="312" y="248" text-anchor="middle" font-size="11" fill="currentColor" opacity="0.85">
                            右下相机
                        </text>
                    </svg>
                    ...
                    <svg
                        v-else-if="props.project.deviceType === CalibDeviceType.ThreeCamera1Light"
                        viewBox="0 0 400 300"
                        class="w-full max-h-72 object-contain"
                        aria-label="3目1光设备布局"
                    >
                        ...
                        <text x="200" y="28" text-anchor="middle" font-size="11" fill="currentColor" opacity="0.85">
                            主相机（中上）
                        </text>
                        <rect
                            x="50"
                        ...
                        <text x="90" y="258" text-anchor="middle" font-size="11" fill="currentColor" opacity="0.85">
                            左下从相机
                        </text>
                        <rect
                            x="270"
                        ...
                        <text x="310" y="258" text-anchor="middle" font-size="11" fill="currentColor" opacity="0.85">
                            右下从相机
                        </text>
                        <polygon
                        ...
                        <rect
                            ...
                            stroke-width="1.5"
                        />
                        <text x="200" y="196" text-anchor="middle" font-size="10" fill="#a78bfa" opacity="0.9">
                            结构光
                        </text>
                    </svg>
                </div>
