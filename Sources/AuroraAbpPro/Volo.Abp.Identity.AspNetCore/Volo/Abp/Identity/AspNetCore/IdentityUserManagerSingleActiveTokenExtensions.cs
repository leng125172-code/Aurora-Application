...
public static class IdentityUserManagerSingleActiveTokenExtensions
{
    ...
    /// </summary>
    public static Task<IdentityResult> RemovePasswordResetTokenAsync(
        this IdentityUserManager manager,
        IdentityUser user
    )
    {
        var name =
    ...
    /// </summary>
    public static Task<IdentityResult> RemoveEmailConfirmationTokenAsync(
        this IdentityUserManager manager,
        IdentityUser user
    )
    {
    ...
    /// </summary>
    public static Task<IdentityResult> RemoveChangeEmailTokenAsync(
        this IdentityUserManager manager,
        IdentityUser user,
        string newEmail
    )
