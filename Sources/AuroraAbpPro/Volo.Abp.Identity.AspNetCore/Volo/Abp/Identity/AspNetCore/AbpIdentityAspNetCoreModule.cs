...
public class AbpIdentityAspNetCoreModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        PreConfigure<IdentityBuilder>(builder =>
        {
            builder
                ...
                .AddTokenProvider<LinkUserTokenProvider>(
                    LinkUserTokenProviderConsts.LinkUserTokenProviderName
                )
                .AddTokenProvider<AbpPasswordResetTokenProvider>(
                    AbpPasswordResetTokenProvider.ProviderName
                )
                .AddTokenProvider<AbpEmailConfirmationTokenProvider>(
                    AbpEmailConfirmationTokenProvider.ProviderName
                )
                .AddTokenProvider<AbpChangeEmailTokenProvider>(
                    AbpChangeEmailTokenProvider.ProviderName
                )
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddScoped(
            typeof(SecurityStampValidator<IdentityUser>),
        ...
        var options = context.Services.ExecutePreConfiguredActions(
            new AbpIdentityAspNetCoreOptions()
        );
    ...
    public override void PostConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context
            .Services.AddAbpOptions<SecurityStampValidatorOptions>()
            .Configure<IServiceProvider>(
                (securityStampValidatorOptions, serviceProvider) =>
                {
                    var abpRefreshingPrincipalOptions = serviceProvider
                        .GetRequiredService<IOptions<AbpRefreshingPrincipalOptions>>()
                        .Value;
