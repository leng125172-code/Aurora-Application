...
public class TypeApiDescriptionModel
{
    ...
    public static TypeApiDescriptionModel Create(Type type)
    {
        ...
        var typeModel = new TypeApiDescriptionModel
        {
            ...
            BaseType =
                baseType != null
                    ? TypeHelper.GetFullNameHandlingNullableAndGenerics(baseType)
                    : null,
        };
        ...
        {
            typeModel.Properties = type.GetProperties(BindingFlags.Instance | BindingFlags.Public)
            ...
            {
                typeModel.GenericArguments = type.GetGenericArguments()
                    .Select(a => a.Name)
                    .ToArray();
            }
        }
