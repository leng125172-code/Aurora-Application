...
public abstract class EventBusBase : IEventBus
{
    ...
    protected abstract void AddToUnitOfWork(
    ...
    protected abstract IEnumerable<EventTypeWithEventHandlerFactories> GetHandlerFactories(
        Type eventType
    );
    ...
    )
    {
        using (var eventHandlerWrapper = asyncHandlerFactory.GetHandler())
        {
            try
            {
                ...
                if (
                    inboxConfig?.HandlerSelector != null
