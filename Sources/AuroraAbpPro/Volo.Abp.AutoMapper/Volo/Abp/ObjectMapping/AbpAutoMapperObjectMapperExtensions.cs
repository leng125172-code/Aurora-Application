...
public static class AbpAutoMapperObjectMapperExtensions
{
    ...
    public static IMapper GetMapper(this IAutoObjectMappingProvider autoObjectMappingProvider)
    {
        if (
            ...
            is AutoMapperAutoObjectMappingProvider autoMapperAutoObjectMappingProvider
        )
        {
        ...
        throw new AbpException(
            $"Given object is not an instance of {typeof(AutoMapperAutoObjectMappingProvider).AssemblyQualifiedName}. The type of the given object it {autoObjectMappingProvider.GetType().AssemblyQualifiedName}"
        );
    }
}
