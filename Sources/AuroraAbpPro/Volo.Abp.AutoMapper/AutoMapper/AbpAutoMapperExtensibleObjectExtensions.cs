...
{
    public static IMappingExpression<TSource, TDestination> MapExtraProperties<
        TSource,
        TDestination
    >(
                ...
                y =>
                    y.MapFrom(
                        (source, destination, extraProps) =>
                        {
                            ...
                            if (
                                source.ExtraProperties == null
                                || destination.ExtraProperties == null
                            )
                            {
                                return result;
                            }
    ...
    public static IMappingExpression<TSource, TDestination> IgnoreExtraProperties<
        TSource,
        TDestination
    >(this IMappingExpression<TSource, TDestination> mappingExpression)
        where TDestination : IHasExtraProperties
