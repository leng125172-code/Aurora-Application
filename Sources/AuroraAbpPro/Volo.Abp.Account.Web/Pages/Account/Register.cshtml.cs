...
public class RegisterModel : AccountPageModel
{
    ...
    public bool IsExternalLoginOnly =>
        EnableLocalRegister == false && ExternalProviders?.Count() == 1;
    ...
    public virtual async Task<IActionResult> OnPostAsync()
    {
        try
        {
            ...
            if (IsExternalLogin)
            {
                ...
                {
                    Input.UserName = await UserManager.GetUserNameFromEmailAsync(
                        Input.EmailAddress
                    );
                }
    ...
    protected virtual async Task RegisterExternalUserAsync(
