...
public class AuditingInterceptor : AbpInterceptor, ITransientDependency
{
    ...
    public override async Task InterceptAsync(IAbpMethodInvocation invocation)
    {
        using (var serviceScope = _serviceScopeFactory.CreateScope())
        {
            ...
            var auditingOptions = serviceScope
            ...
            var auditingManager =
                serviceScope.ServiceProvider.GetRequiredService<IAuditingManager>();
            ...
            else
            {
                ...
                var unitOfWorkManager =
                    serviceScope.ServiceProvider.GetRequiredService<IUnitOfWorkManager>();
    ...
    )
    {
        ...
        if (
            !options.IsEnabledForGetRequests
            && (
