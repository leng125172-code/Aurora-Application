...
internal readonly struct AwaitableInfo
{
    ...
    public static bool IsTypeAwaitable(Type type, out AwaitableInfo awaitableInfo)
    {
        ...
        var implementsINotifyCompletion = awaiterInterfaces.Any(t =>
            t == typeof(INotifyCompletion)
        );
        ...
        var implementsICriticalNotifyCompletion = awaiterInterfaces.Any(t =>
            t == typeof(ICriticalNotifyCompletion)
        );
