...
public class AbpProCapConsumerServiceSelector : ConsumerServiceSelector, ISingletonDependency
{
    ...
    /// </summary>
    public AbpProCapConsumerServiceSelector(
            ...
            foreach (var @interface in interfaces)
            {
                ...
                foreach (var descriptor in descriptors)
                {
                    ...
                    descriptor.Attribute.Group = descriptor.Attribute.Group.Insert(
                        descriptor.Attribute.Group.LastIndexOf(".", StringComparison.Ordinal),
                        $".{count}"
                    );
    ...
    protected virtual IEnumerable<ConsumerExecutorDescriptor> GetHandlerDescription(
        Type eventType,
        Type typeInfo
    )
    {
