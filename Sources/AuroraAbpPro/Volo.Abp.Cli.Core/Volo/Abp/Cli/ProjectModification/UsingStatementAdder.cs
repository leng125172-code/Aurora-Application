...
public class UsingStatementAdder : ITransientDependency
{
    ...
    {
        var indexOfNamespaceDeclaration = fileContent.IndexOf(
            "namespace",
        ...
        var indexOfTheStartOfLastUsingStatement = fileContent.LastIndexOf(
            "using ",
            StringComparison.Ordinal
        );
        ...
        var indexOfFirstSemiColonAfterLastUsingStatement = fileContent
            .Substring(indexOfTheStartOfLastUsingStatement)
            .IndexOf(';');
        ...
        return indexOfTheStartOfLastUsingStatement
            + indexOfFirstSemiColonAfterLastUsingStatement
            + 1;
    }
}
