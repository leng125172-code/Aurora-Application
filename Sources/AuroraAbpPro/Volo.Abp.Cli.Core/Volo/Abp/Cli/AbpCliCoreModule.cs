...
public class AbpCliCoreModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddHttpClient(
            CliConsts.GithubHttpClientName,
            client =>
            {
        ...
        Configure<AbpCliOptions>(options =>
        {
            ...
            options.Commands[RecreateInitialMigrationCommand.Name] =
                typeof(RecreateInitialMigrationCommand);
    ...
    private static void ConfigureTelemetry(IServiceCollection services)
    {
        ...
        if (
            enableTelemetryEnvironmentVariable.IsNullOrEmpty()
            || !enableTelemetryEnvironmentVariable.Equals(
                "false",
        ...
        {
            services.Remove(
                services.First(p => p.ImplementationType == typeof(TelemetrySessionInfoEnricher))
            );
        }
        else
        {
            services.Replace(
                ServiceDescriptor.Singleton<ITelemetryService, NullTelemetryService>()
            );
        }
    }
}
