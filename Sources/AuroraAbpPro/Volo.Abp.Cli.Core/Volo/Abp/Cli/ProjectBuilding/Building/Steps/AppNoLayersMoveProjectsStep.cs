...
public class AppNoLayersMoveProjectsStep : ProjectBuildPipelineStep
{
    public override void Execute(ProjectBuildContext context)
    {
        MoveFiles(
            context,
            "/aspnet-core/MyCompanyName.MyProjectName.Blazor.WebAssembly/Client",
        ...
        MoveFiles(
            context,
            "/aspnet-core/MyCompanyName.MyProjectName.Blazor.WebAssembly/Shared",
        ...
        ModifySolutionFile(
            context,
            "MyCompanyName.MyProjectName.Blazor.WebAssembly\\Server.Mongo\\MyCompanyName.MyProjectName.Host.csproj",
            "MyCompanyName.MyProjectName.Host\\MyCompanyName.MyProjectName.Host.csproj"
        );
        ModifySolutionFile(
            context,
        ...
        ModifyProjectFiles(
            context,
            "..\\Shared\\MyCompanyName.MyProjectName.Blazor.WebAssembly.Shared.csproj",
            "..\\MyCompanyName.MyProjectName.Contracts\\MyCompanyName.MyProjectName.Contracts.csproj"
        );

        ModifyProjectFiles(
            context,
            "..\\Client\\MyCompanyName.MyProjectName.Blazor.WebAssembly.Client.csproj",
            "..\\MyCompanyName.MyProjectName.Blazor\\MyCompanyName.MyProjectName.Blazor.csproj"
        );
    }
    ...
    {
        var slnFile = context.Files.First(file =>
            file.Name.EndsWith(".sln") || file.Name.EndsWith(".slnx")
        );
        slnFile.SetContent(
            slnFile.Content.Replace($"\"{pathInSlnFile}\"", $"\"{newPathInSlnFile}\"")
        );
    }

    public void ModifyProjectFiles(
        ProjectBuildContext context,
        string oldContent,
        string newContent
    )
