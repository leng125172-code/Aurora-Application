...
public class ReplaceDependencyFromPackageJsonFileStep : ProjectBuildPipelineStep
{
    ...
    public ReplaceDependencyFromPackageJsonFileStep(
        string packageJsonFilePath,
        string packageName,
    ...
    {
        var packageJsonFile = context.Files.FirstOrDefault(f =>
            f.Name.Contains(_packageJsonFilePath) && !f.Name.Contains("node_modules")
        );
            ...
            if (lines[i].Contains(_packageName))
            {
                ...
                else
                {
                    ...
                    var prefix =
                        ...
                        : "";
                    lines[i] =
                        $"{space}\"{_newPackageName}\": \"{prefix}{_newPackageVersion}\"{hasComma}";
                }
            }
        }
