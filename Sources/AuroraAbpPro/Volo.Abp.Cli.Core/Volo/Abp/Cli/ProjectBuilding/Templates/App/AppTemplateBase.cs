...
public abstract class AppTemplateBase : TemplateInfo
{
    ...
    public override IEnumerable<ProjectBuildPipelineStep> GetCustomSteps(
    ...
    protected void ConfigureTenantSchema(
        ProjectBuildContext context,
    ...
    )
    {
        if (context.BuildArgs.ExtraProperties.ContainsKey("separate-tenant-schema"))
        {
            ...
            {
                steps.Add(
                    new RemoveProjectFromSolutionStep(
                        "MyCompanyName.MyProjectName.EntityFrameworkCore.DbMigrations"
                    )
                );
                steps.Add(
                    new TemplateProjectRenameStep(
                        "MyCompanyName.MyProjectName.EntityFrameworkCore.SeparateDbMigrations",
                        "MyCompanyName.MyProjectName.EntityFrameworkCore.DbMigrations"
                    )
                );
            }
            else
            {
                ...
                steps.Add(
                    new TemplateProjectRenameStep(
                        "MyCompanyName.MyProjectName.EntityFrameworkCoreWithSeparateDbContext",
                        "MyCompanyName.MyProjectName.EntityFrameworkCore"
                    )
                );
            }
    ...
    protected void SwitchDatabaseProvider(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    protected void DeleteUnrelatedProjects(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
        if (context.BuildArgs.UiFramework != UiFramework.Blazor)
        {
            ...
            steps.Add(
                new RemoveProjectFromSolutionStep("MyCompanyName.MyProjectName.Blazor.Client")
            );
        }
        ...
        {
            steps.Add(
                new RemoveProjectFromSolutionStep("MyCompanyName.MyProjectName.Blazor.Server")
            );
            steps.Add(
                new RemoveProjectFromSolutionStep(
        ...
        {
            steps.Add(
                new RemoveProjectFromSolutionStep("MyCompanyName.MyProjectName.Blazor.WebApp")
            );
            steps.Add(
                new RemoveProjectFromSolutionStep(
        ...
        {
            steps.Add(
                new RemoveFolderStep(MobileApp.ReactNative.GetFolderName().EnsureStartsWith('/'))
            );
        }
        ...
        if (!context.BuildArgs.PublicWebSite)
        {
            ...
            steps.Add(
                new RemoveProjectFromSolutionStep("MyCompanyName.MyProjectName.Web.Public.Host")
            );
        }
        else
        {
            if (
                context.BuildArgs.ExtraProperties.ContainsKey(NewCommand.Options.Tiered.Long)
            ...
            {
                steps.Add(
                    new RemoveProjectFromSolutionStep("MyCompanyName.MyProjectName.Web.Public")
                );
    ...
    protected void ConfigureTheme(ProjectBuildContext context, List<ProjectBuildPipelineStep> steps)
    {
        ...
        ReplaceLeptonXThemePackagesFromPackageJsonFiles(
            steps,
            isProTemplate: IsPro(),
            uiFramework: context.BuildArgs.UiFramework,
            theme: context.BuildArgs.Theme,
            version: context.BuildArgs.Version ?? context.TemplateFile.Version
        );
    }
        ...
        switch (context.BuildArgs.DatabaseManagementSystem)
        {
            ...
            default:
                throw new AbpException(
                    "Unknown Dbms: " + context.BuildArgs.DatabaseManagementSystem
                );
        }
    }

    private void RemoveThemeLogoFolders(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
        ...
        if (
            context.BuildArgs.Theme != Theme.LeptonX
            && context.BuildArgs.Theme != Theme.LeptonXLite
        )
        {
    ...
    private static bool IsDefaultThemeForTemplate(ProjectBuildArgs args)
    {
        ...
        return templateThemes.TryGetValue(args.TemplateName!, out var templateTheme)
            && templateTheme == args.Theme;
    }

    private static void ReplaceLeptonXThemePackagesFromPackageJsonFiles(
        List<ProjectBuildPipelineStep> steps,
        bool isProTemplate,
    ...
    {
        var mvcUiPackageName = isProTemplate
        ...
        {
            steps.Add(
                new ReplaceDependencyFromPackageJsonFileStep(
                    packageJsonFilePath,
                    mvcUiPackageName,
                    newMvcUiPackageName,
                    version
        ...
        {
            var blazorServerUiPackageName = isProTemplate
            ...
            foreach (var blazorServerPackageJsonFilePath in blazorServerPackageJsonFilePaths)
            {
                steps.Add(
                    new ReplaceDependencyFromPackageJsonFileStep(
                        blazorServerPackageJsonFilePath,
                        mvcUiPackageName,
                        newMvcUiPackageName,
                        version
                    )
                ...
                steps.Add(
                    new ReplaceDependencyFromPackageJsonFileStep(
                        blazorServerPackageJsonFilePath,
                        blazorServerUiPackageName,
                        newBlazorServerUiPackageName,
                        version
                    )
                );
            }
        ...
        {
            var ngUiPackageName = isProTemplate
            ...
            var angularPackageJsonFilePaths = new List<string> { "/angular/package.json" };

            foreach (var angularPackageJsonFilePath in angularPackageJsonFilePaths)
            {
                steps.Add(
                    new ReplaceDependencyFromPackageJsonFileStep(
                        angularPackageJsonFilePath,
                        ngUiPackageName,
                        newNgUiPackageName,
                        version
                    )
                ...
                {
                    steps.Add(
                        new RemoveDependencyFromPackageJsonFileStep(
                            angularPackageJsonFilePath,
                            "bootstrap-icons"
                        )
                    );
    ...
    protected void ConfigurePublicWebSite(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
        ...
        )
        {
            steps.Add(
                new TemplateProjectRenameStep(
                    "MyCompanyName.MyProjectName.Web.Public.Host",
                    "MyCompanyName.MyProjectName.Web.Public"
                )
            );
            steps.Add(new ChangeDbMigratorPublicPortStep());
        }
        else if (
            context.BuildArgs.UiFramework != UiFramework.NotSpecified
            && context.BuildArgs.UiFramework != UiFramework.Mvc
        )
        {
        ...
        if (
            context.BuildArgs.PublicWebSite
            && !context.BuildArgs.ExtraProperties.ContainsKey("without-cms-kit")
            && IsCmsKitSupportedForTargetVersion(context)
        )
        {
    ...
    protected static void RemoveCmsKitDependenciesFromPackageJsonFiles(
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    protected void ConfigureWithoutUi(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
        ...
        steps.Add(
            new RemoveProjectFromSolutionStep(
                ...
                projectFolderPath: "/aspnet-core/test/MyCompanyName.MyProjectName.Web.Tests"
            )
        );
        ...
        {
            steps.Add(
                new RemoveProjectFromSolutionStep("MyCompanyName.MyProjectName.HttpApi.HostWithIds")
            );
        ...
        {
            steps.Add(
                new RemoveProjectFromSolutionStep("MyCompanyName.MyProjectName.HttpApi.Host")
            );
    ...
    protected void ConfigureWithBlazorUi(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
        ...
        else
        {
            ...
            steps.Add(
                new RemoveProjectFromSolutionStep("MyCompanyName.MyProjectName.IdentityServer")
            );
            steps.Add(new RemoveProjectFromSolutionStep("MyCompanyName.MyProjectName.AuthServer"));
            steps.Add(
                new TemplateProjectRenameStep(
        ...
        if (
            context.BuildArgs.ExtraProperties.ContainsKey(
                NewCommand.Options.ProgressiveWebApp.Short
            )
        )
        {
        ...
        else
        {
            steps.Add(
                new RemoveFileStep(
                    "/aspnet-core/src/MyCompanyName.MyProjectName.Blazor/wwwroot/service-worker.js"
                )
            );
            steps.Add(
                new RemoveFileStep(
                    "/aspnet-core/src/MyCompanyName.MyProjectName.Blazor/wwwroot/service-worker.published.js"
                )
            );
            steps.Add(
                new RemoveFileStep(
                    "/aspnet-core/src/MyCompanyName.MyProjectName.Blazor/wwwroot/manifest.json"
                )
            );
            steps.Add(
                new RemoveFileStep(
                    "/aspnet-core/src/MyCompanyName.MyProjectName.Blazor/wwwroot/icon-192.png"
                )
            );
            steps.Add(
                new RemoveFileStep(
                    "/aspnet-core/src/MyCompanyName.MyProjectName.Blazor/wwwroot/icon-512.png"
                )
            );
        }
    }

    protected void ConfigureWithBlazorServerUi(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    protected void ConfigureWithBlazorWebAppUi(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    protected void ConfigureWithMvcUi(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    protected void ConfigureWithAngularUi(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    protected void ConfigureWithMauiBlazorUi(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
        ...
        steps.Add(
            new RemoveFileStep(
                "/aspnet-core/src/MyCompanyName.MyProjectName.MauiBlazor/Directory.Build.props"
            )
        );
    ...
    protected void RemoveUnnecessaryPorts(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    {
        if (
            context.BuildArgs.Version == null
            || SemanticVersion.Parse(context.BuildArgs.Version)
                >= SemanticVersion.Parse("6.0.0-rc.1")
        )
        {
    ...
    protected void ConfigureTieredArchitecture(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    protected void RandomizeStringEncryption(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    protected static void RandomizeAuthServerPassPhrase(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    protected void UpdateNuGetConfig(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    protected void RemoveMigrations(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
        if (
            string.IsNullOrWhiteSpace(context.BuildArgs.Version)
        ...
        )
        {
            ...
            {
                steps.Add(
                    new RemoveFolderStep(
                        "/aspnet-core/src/MyCompanyName.MyProjectName.EntityFrameworkCore.DbMigrations/Migrations"
                    )
                );
                steps.Add(
                    new RemoveFolderStep(
                        "/aspnet-core/src/MyCompanyName.MyProjectName.EntityFrameworkCore.DbMigrations/TenantMigrations"
                    )
                );
            }
            else
            {
                steps.Add(
                    new RemoveFolderStep(
                        "/aspnet-core/src/MyCompanyName.MyProjectName.EntityFrameworkCore/Migrations"
                    )
                );
                steps.Add(
                    new RemoveFolderStep(
                        "/aspnet-core/src/MyCompanyName.MyProjectName.EntityFrameworkCore/TenantMigrations"
                    )
                );
            }
        }
    ...
    protected void CleanupFolderHierarchy(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
    ...
    private void ConfigureDockerFiles(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
        switch (context.BuildArgs.UiFramework)
        {
            case UiFramework.None:
                ...
                steps.Add(
                    new RemoveFileStep("/aspnet-core/etc/docker/docker-compose.Blazor.Server.yml")
                );
                ...
                steps.Add(
                    new MoveFileStep(
                        "/aspnet-core/etc/docker/docker-compose.Angular.yml",
            ...
            case UiFramework.Blazor:
                ...
                steps.Add(
                    new MoveFileStep(
                        "/aspnet-core/etc/docker/docker-compose.Blazor.yml",
                        "/aspnet-core/etc/docker/docker-compose.yml"
                    )
                );
                break;
            ...
            case UiFramework.BlazorWebApp:
                ...
                steps.Add(
                    new MoveFileStep(
                        "/aspnet-core/etc/docker/docker-compose.Blazor.Server.yml",
                        "/aspnet-core/etc/docker/docker-compose.yml"
                    )
                );
                break;
            ...
            case UiFramework.Mvc:
                ...
                steps.Add(
                    new MoveFileStep(
                        "/aspnet-core/etc/docker/docker-compose.Mvc.yml",
                        "/aspnet-core/etc/docker/docker-compose.yml"
                    )
                );
                break;
