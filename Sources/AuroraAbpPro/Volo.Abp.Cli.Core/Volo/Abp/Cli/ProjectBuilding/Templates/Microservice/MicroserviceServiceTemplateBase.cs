...
public abstract class MicroserviceServiceTemplateBase : TemplateInfo
{
    ...
    private static void DeleteUnrelatedUiProject(
        ProjectBuildContext context,
    ...
    )
    {
        switch (context.BuildArgs.UiFramework)
        {
            case UiFramework.Blazor:
                steps.Add(
                    new RemoveProjectFromSolutionStep(
                        "MyCompanyName.MyProjectName.MicroserviceName.Web"
                    )
                );
                break;
            ...
            case UiFramework.NotSpecified:
                steps.Add(
                    new RemoveProjectFromSolutionStep(
                        "MyCompanyName.MyProjectName.MicroserviceName.Blazor"
                    )
                );
                break;
            default:
    ...
    private static void SetRandomPortForHostProject(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
