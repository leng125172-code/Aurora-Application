...
public abstract class AppNoLayersTemplateBase : TemplateInfo
{
    ...
    )
    {
        switch (context.BuildArgs.DatabaseProvider)
        {
            ...
            case DatabaseProvider.EntityFrameworkCore:
                ...
                steps.Add(
                    new RemoveProjectFromSolutionStep("MyCompanyName.MyProjectName.Mvc.Mongo")
                );
                steps.Add(
                    new RemoveProjectFromSolutionStep("MyCompanyName.MyProjectName.Host.Mongo")
                );
                steps.Add(
            ...
            case DatabaseProvider.MongoDb:
                ...
                steps.Add(
                    new RemoveProjectFromSolutionStep(
                        "MyCompanyName.MyProjectName.Blazor.WebAssembly.Server",
                ...
                steps.Add(
                    new MoveFolderStep(
                        "/aspnet-core/MyCompanyName.MyProjectName.Blazor.WebAssembly/Server.Mongo",
                        "/aspnet-core/MyCompanyName.MyProjectName.Blazor.WebAssembly/Server"
                    )
                );
                steps.Add(
                    new ProjectRenameStep(
    ...
    )
    {
        switch (context.BuildArgs.UiFramework)
        {
            ...
            case UiFramework.BlazorWebApp:
                ...
                steps.Add(
                    new ProjectRenameStep(
                        "MyCompanyName.MyProjectName.Blazor.WebAssembly.Client",
                        "MyCompanyName.MyProjectName.Blazor"
                    )
                );
                steps.Add(
                    new ProjectRenameStep(
                        "MyCompanyName.MyProjectName.Blazor.WebAssembly.Shared",
                ...
                steps.Add(
                    new RemoveFolderStep(
                        "/aspnet-core/MyCompanyName.MyProjectName.Blazor.WebAssembly"
                    )
                );
                break;
    ...
    protected void ConfigureDockerFiles(
        ProjectBuildContext context,
        List<ProjectBuildPipelineStep> steps
    )
    {
        switch (context.BuildArgs.UiFramework)
        {
            case UiFramework.None:
                ...
                steps.Add(
                    new MoveFileStep(
                        "/aspnet-core/etc/docker/docker-compose.Host.yml",
    ...
    private static void RemoveBlazorWasmProjects(List<ProjectBuildPipelineStep> steps)
    {
        ...
        steps.Add(
            new RemoveFolderStep("/aspnet-core/MyCompanyName.MyProjectName.Blazor.WebAssembly")
        );
    }
