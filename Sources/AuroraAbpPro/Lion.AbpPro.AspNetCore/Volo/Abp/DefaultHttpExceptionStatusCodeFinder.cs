...
/// </summary>
public class DefaultHttpExceptionStatusCodeFinder
        ...
        ITransientDependency
{
    ...
    {
        if (
            exception is IHasHttpStatusCode exceptionWithHttpStatusCode
        ...
        {
            if (
                Options.ErrorCodeToHttpStatusCodeMappings.TryGetValue(
                    exceptionWithErrorCode.Code,
                    out var status
                )
            )
            {
