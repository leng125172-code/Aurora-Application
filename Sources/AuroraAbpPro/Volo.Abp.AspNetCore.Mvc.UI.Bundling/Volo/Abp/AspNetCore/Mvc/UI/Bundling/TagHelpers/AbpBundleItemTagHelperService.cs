...
public abstract class AbpBundleItemTagHelperService<TTagHelper, TService>
    ...
    where TService : class, IAbpTagHelperService<TTagHelper>
{
    ...
    {
        var tagHelperItems =
            context.Items.GetOrDefault(AbpTagHelperConsts.ContextBundleItemListKey)
            as List<BundleTagHelperItem>;
        ...
        else
        {
            await ResourceService.ProcessAsync(
                ...
                context,
                output,
                new List<BundleTagHelperItem> { TagHelper.CreateBundleTagHelperItem() },
