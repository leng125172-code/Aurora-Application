...
public static class MemoryDbCoreRepositoryExtensions
{
    ...
    public static IMemoryDatabase GetDatabase<TEntity, TKey>(
    ...
    public static Task<IMemoryDatabase> GetDatabaseAsync<TEntity, TKey>(
        this IBasicRepository<TEntity, TKey> repository
    )
        where TEntity : class, IEntity<TKey>
    {
    ...
    public static IMemoryDatabaseCollection<TEntity> GetCollection<TEntity, TKey>(
        this IBasicRepository<TEntity, TKey> repository
    )
        where TEntity : class, IEntity<TKey>
    {
    ...
    public static Task<IMemoryDatabaseCollection<TEntity>> GetCollectionAsync<TEntity, TKey>(
        this IBasicRepository<TEntity, TKey> repository
    )
        where TEntity : class, IEntity<TKey>
    {
    ...
    public static IMemoryDbRepository<TEntity, TKey> ToMemoryDbRepository<TEntity, TKey>(
        this IBasicRepository<TEntity, TKey> repository
    )
        where TEntity : class, IEntity<TKey>
    {
        ...
        if (memoryDbRepository == null)
        {
            throw new ArgumentException(
                "Given repository does not implement "
                    + typeof(IMemoryDbRepository<TEntity, TKey>).AssemblyQualifiedName,
                nameof(repository)
            );
        }
