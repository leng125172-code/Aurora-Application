namespace Lion.AbpPro.NotificationManagement.EntityFrameworkCore
{
    ...
    public class NotificationManagementDbContext
        : AbpDbContext<NotificationManagementDbContext>,
            INotificationManagementDbContext
    {
        ...
        public NotificationManagementDbContext(
            DbContextOptions<NotificationManagementDbContext> options
        )
            : base(options) { }
