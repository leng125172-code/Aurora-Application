...
public class AbpComponentDemoSectionTagHelper : AbpTagHelper
{
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        output.PreContent.AppendHtml(
            $"<div class=\"col\"><h4 class=\"card-title my-1\">{Title}</h4></div>"
        );
        ...
        output.PreContent.AppendHtml(
            $"<a class=\"nav-item nav-link active\" id=\"nav-preview-tab-{previewId}\" data-bs-toggle=\"tab\" href=\"#nav-preview-{previewId}\" role=\"tab\" aria-controls=\"nav-preview-{previewId}\" aria-selected=\"true\">Preview</a>"
        );
        output.PreContent.AppendHtml(
            $"<a class=\"nav-item nav-link\" id=\"nav-code-tab-{codeBlockId}\" data-bs-toggle=\"tab\" href=\"#nav-code-{codeBlockId}\" role=\"tab\" aria-controls=\"nav-code-{codeBlockId}\" aria-selected=\"false\">Code</a>"
        );
        ...
        output.PreContent.AppendHtml(
            $"<div class=\"tab-content\" id=\"nav-preview-tabContent-{previewId}\">"
        );
        output.PreContent.AppendHtml(
            $"<div class=\"tab-pane fade show active\" id=\"nav-preview-{previewId}\" role=\"tabpanel\" aria-labelledby=\"nav-preview-tab-{previewId}\">"
        );
        ...
        output.PostContent.AppendHtml(
            $"<div class=\"tab-pane fade\" id=\"nav-code-{codeBlockId}\" role=\"tabpanel\" aria-labelledby=\"nav-code-tab-{codeBlockId}\">"
        );

        /* CodeBlock tabs */

        output.PostContent.AppendHtml(
            $"<ul class=\"nav nav-tabs\" id=\"code-block-tab-{codeBlockTabId}\" role=\"tablist\">"
        );
        output.PostContent.AppendHtml("<li class=\"nav-item\">");
        output.PostContent.AppendHtml(
            $"<a class=\"nav-link active\" id=\"tag-helper-tab-{tagHelperCodeBlockId}\" data-bs-toggle=\"pill\" href=\"#tag-helper-{tagHelperCodeBlockId}\" role=\"tab\" aria-controls=\"tag-helper-{tagHelperCodeBlockId}\" aria-selected=\"true\">Abp Tag Helper</a>"
        );
        output.PostContent.AppendHtml("</li>");
        output.PostContent.AppendHtml("<li class=\"nav-item\">");
        output.PostContent.AppendHtml(
            $"<a class=\"nav-link\" id=\"bootstrap-tab-{bootstrapCodeBlockId}\" data-bs-toggle=\"pill\" href=\"#bootstrap-{bootstrapCodeBlockId}\" role=\"tab\" aria-controls=\"bootstrap-{tagHelperCodeBlockId}\" aria-selected=\"true\">Bootstrap</a>"
        );
        output.PostContent.AppendHtml("</li>");
        output.PostContent.AppendHtml("</ul>");
        output.PostContent.AppendHtml(
            $"<div class=\"tab-content\" id=\"code-block-tabContent-{codeBlockTabId}\">"
        );

        output.PostContent.AppendHtml(
            $"<div class=\"tab-pane fade show active\" id=\"tag-helper-{tagHelperCodeBlockId}\" role=\"tabpanel\" aria-labelledby=\"tag-helper-tab-{tagHelperCodeBlockId}\">"
        );
        ...
        output.PostContent.AppendHtml(
            $"<div class=\"tab-pane fade\" id=\"bootstrap-{bootstrapCodeBlockId}\" role=\"tabpanel\" aria-labelledby=\"bootstrap-tab-{bootstrapCodeBlockId}\">"
        );
        output.PostContent.AppendHtml("<pre class=\"p-4\">");
        output.PostContent.AppendHtml("<code class=\"language-html\">");
    ...
    private string GetRawDemoSource()
    {
        ...
        foreach (var line in lines)
        {
            if (line.Contains(DemoSectionOpeningTag) && GetName(line) == Title)
            {
                ...
                line.Contains(DemoSectionClosingTag, StringComparison.InvariantCultureIgnoreCase)
            )
            {
    ...
    {
        var str = line.Substring(
            line.IndexOf("title=\"", StringComparison.OrdinalIgnoreCase) + "title=\"".Length
        );
