...
{
    Task<DataDictionaryDto> FindByIdAsync(Guid id, CancellationToken cancellationToken = default);
    ...
    Task<DataDictionary> UpdateAsync(Guid dataDictionaryId, string displayText, string description);
