    ...
    public class DataDictionaryManager : DataDictionaryDomainService, IDataDictionaryManager
    {
        ...
        )
        {
            ...
            return await _cache.GetOrAddAsync(
                ...
                async () =>
                {
                    var entity = await _dataDictionaryRepository.FindByIdAsync(
                        id,
                        true,
                        cancellationToken
                    );
        ...
        )
        {
            ...
            return await _cache.GetOrAddAsync(
                ...
                async () =>
                {
                    var entity = await _dataDictionaryRepository.FindByCodeAsync(
                        code,
                        true,
                        cancellationToken
                    );
        ...
        )
        {
            ...
            if (entity != null)
                throw new DataDictionaryDomainException(
                    DataDictionaryManagementErrorCodes.DataDictionaryExist
                );
        ...
        )
        {
            ...
            if (entity == null)
                throw new DataDictionaryDomainException(
                    DataDictionaryManagementErrorCodes.DataDictionaryNotExist
                );
            if (entity.Details.Any(e => e.Code == code.Trim()))
            {
                throw new DataDictionaryDomainException(
                    DataDictionaryManagementErrorCodes.DataDictionaryDetailExist
                );
            }
        ...
        )
        {
            ...
            {
                throw new DataDictionaryDomainException(
                    DataDictionaryManagementErrorCodes.DataDictionaryDetailNotExist
                );
            }

            detail.UpdateDetail(dataDictionaryDetailId, displayText, description, order);
            return await _dataDictionaryRepository.UpdateAsync(entity);
        }
