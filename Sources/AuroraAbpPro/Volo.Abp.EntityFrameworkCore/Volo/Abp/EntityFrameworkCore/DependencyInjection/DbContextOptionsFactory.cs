...
public static class DbContextOptionsFactory
{
        ...
        where TDbContext : AbpDbContext<TDbContext>
    {
        ...
        if (
            serviceProvider
                .GetRequiredService<IOptions<AbpEfCoreGlobalFilterOptions>>()
                .Value.UseDbFunction
        )
        {
        ...
        where TDbContext : AbpDbContext<TDbContext>
    {
        ...
        if (!preConfigureActions.IsNullOrEmpty())
        {
            ...
            {
                ((Action<AbpDbContextConfigurationContext<TDbContext>>)preConfigureAction).Invoke(
                    context
                );
            }
        }
        ...
        where TDbContext : AbpDbContext<TDbContext>
    {
        ...
        var connectionString = ResolveConnectionString<TDbContext>(
            serviceProvider,
