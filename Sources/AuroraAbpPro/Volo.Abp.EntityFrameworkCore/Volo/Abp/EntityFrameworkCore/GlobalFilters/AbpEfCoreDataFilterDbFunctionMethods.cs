...
{
    public const string NotSupportedExceptionMessage =
        "Your EF Core database provider does not support 'User-defined function mapping'."
    ...
    public static MethodInfo SoftDeleteFilterMethodInfo =>
        typeof(AbpEfCoreDataFilterDbFunctionMethods).GetMethod(nameof(SoftDeleteFilter))!;
    ...
    public static MethodInfo MultiTenantFilterMethodInfo =>
        typeof(AbpEfCoreDataFilterDbFunctionMethods).GetMethod(nameof(MultiTenantFilter))!;
}
