...
public static class AbpEntityTypeBuilderExtensions
{
    ...
    static AbpEntityTypeBuilderExtensions()
    {
        ...
        {
            new NamedEntityConfigurer("ConcurrencyStamp", b => b.TryConfigureConcurrencyStamp()),
            new NamedEntityConfigurer("ExtraProperties", b => b.TryConfigureExtraProperties()),
            new NamedEntityConfigurer("ObjectExtensions", b => b.TryConfigureObjectExtensions()),
            new NamedEntityConfigurer("MayHaveCreator", b => b.TryConfigureMayHaveCreator()),
            new NamedEntityConfigurer("MustHaveCreator", b => b.TryConfigureMustHaveCreator()),
            new NamedEntityConfigurer("SoftDelete", b => b.TryConfigureSoftDelete()),
            new NamedEntityConfigurer("DeletionTime", b => b.TryConfigureDeletionTime()),
            new NamedEntityConfigurer("DeletionAudited", b => b.TryConfigureDeletionAudited()),
            new NamedEntityConfigurer("CreationTime", b => b.TryConfigureCreationTime()),
            ...
            new NamedEntityConfigurer("MultiTenant", b => b.TryConfigureMultiTenant()),
        };
    }
    ...
    public static void TryConfigureExtraProperties(this EntityTypeBuilder b)
    {
        ...
        var extraPropertiesValueConverter = Activator
            .CreateInstance(type)!
            .As<ValueConverter<ExtraPropertyDictionary, string>>();
