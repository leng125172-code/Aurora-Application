...
public static class EfCoreObjectExtensionManagerExtensions
{
    ...
    {
        return MapEfCoreEntity(objectExtensionManager, typeof(TEntity), entityTypeBuildAction);
    }
    ...
    )
    {
        ...
        return objectExtensionManager.AddOrUpdateProperty(
            ...
            options =>
            {
                options.MapEfCore(propertyBuildAction);
            }
        );
    }
    ...
    )
    {
        ...
        return objectExtensionManager.AddOrUpdateProperty(
            ...
            options =>
            {
                options.MapEfCore(entityTypeAndPropertyBuildAction);
            }
        );
    }
