namespace Lion.AbpPro.CodeManagement.EnumTypes.Aggregates
{
    /// <summary>
    /// 枚举
    /// </summary>
    public class EnumType : FullAuditedAggregateRoot<Guid>, IMultiTenant
    {
        ...
        public void AddProperty(Guid id, string code, int value, string description)
        {
        ...
        public void UpdateProperty(Guid id, string code, int value, string description)
        {
            ...
            var propertyValue = EnumTypeProperties.FirstOrDefault(e =>
                e.Value == value && e.Id != id
            );
