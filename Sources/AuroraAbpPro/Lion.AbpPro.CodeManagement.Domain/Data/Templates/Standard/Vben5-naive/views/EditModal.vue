...
import { post{{ context.EntityModel.AggregateCodePluralized }}Update } from '#/api-client/index';
...
const [Modal, modalApi] = useVbenModal({
  ...
  async onConfirm() {
    ...
    try {
      ...
      // 编辑
      await post{{ context.EntityModel.AggregateCodePluralized }}Update({ body: { ...values } });
