namespace Lion.AbpPro.CodeManagement.Templates.Aggregates;
...
public class Template : FullAuditedAggregateRoot<Guid>, IMultiTenant
{
    ...
    public Template(Guid id, string name, string remark, Guid? tenantId = null)
        : base(id)
    {
        TemplateDetails = new List<TemplateDetail>();
    ...
    {
        Guard.NotNullOrWhiteSpace(name, nameof(name), CodeManagementConsts.MaxLength128);
        Name = name;
    }

    private void SetRemark(string remark)
    {
        Guard.Length(remark, nameof(remark), CodeManagementConsts.MaxLength512);
        Remark = remark;
    }
    ...
    /// 新增模板明细
    /// </summary>
    public TemplateDetail AddTemplateDetail(
        Guid id,
