...
public class PermissionGroupDefinition : ICanAddChildPermission
{
    ...
    {
        var permission = new PermissionDefinition(name, displayName, multiTenancySide, isEnabled);

        permission[PermissionDefinitionContext.KnownPropertyNames.CurrentProviderName] = this[
