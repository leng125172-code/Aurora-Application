...
namespace Lion.AbpPro.DataDictionaryManagement.DataDictionaries
{
            ...
            IDataDictionaryAppService
    {
        ...
        [HttpPost("findByCode")]
        [SwaggerOperation(summary: "通过code查询字典信息", Tags = new[] { "DataDictionary" })]
        public Task<DataDictionaryDto> FindByCodeAsync(FindByCodeInput input)
        {
            return _dataDictionaryAppService.FindByCodeAsync(input);
        }
    }
}
