...
public class EnumTypeAppService : CodeManagementAppService, IEnumTypeAppService
{
    ...
    public async Task<PagedResultDto<PageEnumTypeOutput>> PageAsync(PageEnumTypeInput input)
    {
        ...
        result.Items = list.Adapt<List<PageEnumTypeOutput>>();
        return result;
    }

    public async Task<PagedResultDto<PageEnumTypePropertyOutput>> PagePropertyAsync(
        PageEnumTypePropertyInput input
    )
    {
        var entity = await _enumTypeManager.FindAsync(input.Id);
        if (entity == null)
            return new PagedResultDto<PageEnumTypePropertyOutput>();
        var result = new PagedResultDto<PageEnumTypePropertyOutput>
        {
            TotalCount = entity.EnumTypeProperties.Count,
        };
        var properties = entity
            .EnumTypeProperties.WhereIf(
            ...
            .Take(input.PageSize)
            .ToList();
        result.Items = properties.Adapt<List<PageEnumTypePropertyOutput>>();
        return result;
    }

    public Task CreateEnumTypeAsync(CreateEnumTypeInput input)
    {
        return _enumTypeManager.CreateAsync(
            input.Code,
            input.Description,
            input.EntityModelId,
            input.ProjectId
    ...
    {
        return _enumTypeManager.CreatePropertyAsync(
            input.Code,
            input.Value,
            input.Description,
            input.EnumTypeId
    ...
    {
        return _enumTypeManager.UpdatePropertyAsync(
            input.Id,
            input.Code,
            input.Value,
            input.Description,
