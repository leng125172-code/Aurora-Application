...
public static class AbpApiVersioningExtensions
{
    ...
    )
    {
        ...
        return services
            .AddApiVersioning(apiVersioningOptionsSetupAction)
            .AddMvc(mvcApiVersioningOptionsSetupAction);
    }

    public static void ConfigureAbp(
        this MvcApiVersioningOptions options,
    ...
    private static void ConfigureApiVersionsByConvention(
        MvcApiVersioningOptions options,
