        ...
        ISingletonDependency
{
    ...
    protected virtual void AddExtraPropertyValidationsAttributes(
        ViewContext viewContext,
        ModelExplorer modelExplorer,
        IDictionary<string, string> attributes
    )
    {
        ...
        var extensibleObjectType = modelExplorer
            .Container.ModelType.GetProperty(
                containerName,
        ...
        foreach (var validationAttribute in extensionPropertyInfo.GetValidationAttributes())
        {
            ...
            var validationAttributeAdapter =
