...
public abstract class ChallengeAccountController : AbpController
{
    ...
    [HttpGet]
    public virtual async Task<ActionResult> LoginAsync(
        string returnUrl = "",
    ...
    )
    {
        ...
        return Challenge(
            ...
            {
                RedirectUri = await GetRedirectUrlAsync(returnUrl, returnUrlHash),
            },
    ...
    [HttpGet]
    public virtual async Task<ActionResult> LogoutAsync(
        string returnUrl = "",
        string returnUrlHash = ""
    )
    {
    ...
    [HttpGet]
    public virtual async Task<ActionResult> ChallengeAsync(
        string returnUrl = "",
        string returnUrlHash = ""
    )
    {
