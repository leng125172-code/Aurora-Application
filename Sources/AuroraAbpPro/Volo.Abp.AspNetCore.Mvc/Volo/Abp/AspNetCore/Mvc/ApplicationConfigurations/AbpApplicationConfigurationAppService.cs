...
public class AbpApplicationConfigurationAppService
    : ApplicationService,
        IAbpApplicationConfigurationAppService
{
    ...
    )
    {
        ...
        if (_options.Contributors.Any())
        {
            ...
            {
                var context = new ApplicationConfigurationContributorContext(
    ...
    protected virtual async Task<TimingDto> GetTimingConfigAsync()
    {
        ...
        if (!timeZone.IsNullOrWhiteSpace())
        {
            ...
            catch (Exception ex)
            {
                ...
                Logger.LogWarning(
                    ex,
                    $"Exception occurred while getting timezone({timeZone}) information"
                );
            }
        }
        ...
        return new TimingDto
        {
            ...
            {
                Windows = new WindowsTimeZone { TimeZoneId = timeZoneId },
                Iana = new IanaTimeZone { TimeZoneName = timeZoneName },
            },
        };
    }
