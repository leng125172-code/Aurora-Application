...
public class AbpExtraPropertyModelBinder : IModelBinder
{
    ...
    public virtual Task BindModelAsync(ModelBindingContext bindingContext)
    {
        ...
        var model = ConvertStringToPropertyType(bindingContext, valueProviderResult.FirstValue);
    ...
    protected virtual object? ConvertStringToPropertyType(
    ...
    )
    {
        ...
        var propertyName = ExtraPropertyBindingHelper.ExtractExtraPropertyName(
