        ...
        ITransientDependency
{
    ...
    {
        var permissionGrantsInRole = await PermissionGrantRepository.GetListAsync(
        ...
        var resourcePermissionGrantsInRole = await ResourcePermissionGrantRepository.GetListAsync(
            RoleResourcePermissionValueProvider.ProviderName,
            eventData.OldName
        );
        foreach (var resourcePermissionGrant in resourcePermissionGrantsInRole)
        {
            await ResourcePermissionManager.UpdateProviderKeyAsync(
