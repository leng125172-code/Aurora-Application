...
public class NotificationSubscriptionManager
    : NotificationManagementDomainService,
        INotificationSubscriptionManager
{
    ...
    {
        var subscription = await _notificationSubscriptionRepository.FindAsync(
            receiveUserId,
            notificationId
        );
    ...
    public async Task<List<NotificationSubscriptionDto>> GetPagingListAsync(
        Guid notificationId,
        Guid? receiverUserId,
    ...
    {
        var list = await _notificationSubscriptionRepository.GetPagingListAsync(
            notificationId,
            receiverUserId,
            receiverUserName,
            startReadTime,
    ...
    public async Task<List<NotificationSubscriptionDto>> GetListAsync(
        List<Guid> notificationId,
        Guid receiverUserId,
        CancellationToken cancellationToken = default
    )
    {
        var list = await _notificationSubscriptionRepository.GetListAsync(
            notificationId,
            receiverUserId,
            cancellationToken
        );
    ...
    public async Task<NotificationSubscriptionDto> FindAsync(
        Guid receiveUserId,
        Guid notificationId,
        CancellationToken cancellationToken = default
    )
    ...
    public async Task DeleteAsync(Guid id, CancellationToken cancellationToken = default)
    {
        ...
        if (subscription == null)
            throw new NotificationManagementDomainException(
                NotificationManagementErrorCodes.MessageNotExist
            );
        await _notificationSubscriptionRepository.DeleteAsync(
            subscription.Id,
            false,
            cancellationToken
        );
    ...
    {
        return await _notificationSubscriptionRepository.GetPagingCountAsync(
            notificationId,
            receiverUserId,
            receiverUserName,
            startReadTime,
