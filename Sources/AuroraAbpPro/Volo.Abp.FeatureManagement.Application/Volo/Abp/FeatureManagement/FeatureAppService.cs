...
public class FeatureAppService : FeatureManagementAppServiceBase, IFeatureAppService
{
    ...
    )
    {
        ...
        foreach (var feature in input.Features)
        {
            ...
            {
                if (
                    inputFeatureNames.Contains(childFeature.Name)
    ...
    protected virtual void SetFeatureDepth(
        List<FeatureDto> features,
        string providerName,
        string providerKey,
        FeatureDto parentFeature = null,
        int depth = 0
    )
    {
        foreach (var feature in features)
        {
            if (
                (parentFeature == null && feature.ParentName == null)
