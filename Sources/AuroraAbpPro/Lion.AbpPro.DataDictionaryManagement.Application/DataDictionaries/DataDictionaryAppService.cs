...
namespace Lion.AbpPro.DataDictionaryManagement.DataDictionaries
{
    ...
    public class DataDictionaryAppService
        : DataDictionaryManagementAppService,
            IDataDictionaryAppService
    {
        ...
        /// 分页查询字典项
        /// </summary>
        public virtual async Task<PagedResultDto<PagingDataDictionaryOutput>> GetPagingListAsync(
        ...
        )
        {
            ...
            var entities = await _dataDictionaryRepository.GetPagingListAsync(
                input.Filter,
                input.PageSize,
                input.SkipCount,
                false
        ...
        public virtual async Task<
            PagedResultDto<PagingDataDictionaryDetailOutput>
        > GetPagingDetailListAsync(PagingDataDictionaryDetailInput input)
        {
            ...
            var details = entity
                .Details.WhereIf(
                    ...
                    e => (e.Code.Contains(input.Filter) || e.DisplayText.Contains(input.Filter))
                )
                .OrderBy(e => e.Order)
        ...
        {
            return _dataDictionaryManager.CreateAsync(
                input.Code,
                input.DisplayText,
                input.Description
            );
        ...
        {
            return _dataDictionaryManager.CreateDetailAsync(
                input.Id,
                input.Code,
                input.DisplayText,
                input.Description,
        ...
        {
            return _dataDictionaryManager.SetStatus(
                input.DataDictionaryId,
                input.DataDictionayDetailId,
                input.IsEnabled
            );
        }
        ...
        {
            return _dataDictionaryManager.UpdateDetailAsync(
                input.DataDictionaryId,
                input.Id,
                input.DisplayText,
                input.Description,
        ...
        {
            return _dataDictionaryManager.DeleteAsync(
                input.DataDictionaryId,
                input.DataDictionayDetailId
            );
        }
        ...
        {
            return _dataDictionaryManager.UpdateAsync(
                input.Id,
                input.DisplayText,
                input.Description
            );
        ...
        [Authorize]
        public virtual async Task<DataDictionaryDto> FindByCodeAsync(FindByCodeInput input)
        {
            return await _dataDictionaryManager.FindByCodeAsync(input.Code);
        }
    }
}
