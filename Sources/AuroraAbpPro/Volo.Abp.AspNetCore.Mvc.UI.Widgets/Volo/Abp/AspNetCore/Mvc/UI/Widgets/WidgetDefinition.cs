...
public class WidgetDefinition
{
    ...
    private static List<WidgetResourceItem> GetStyles(WidgetAttribute widgetAttribute)
    {
        ...
        {
            styles.AddRange(
                widgetAttribute.StyleTypes!.Select(type => new WidgetResourceItem(type))
            );
        }
    ...
    private static List<WidgetResourceItem> GetScripts(WidgetAttribute widgetAttribute)
    {
        ...
        {
            scripts.AddRange(
                widgetAttribute.ScriptTypes!.Select(type => new WidgetResourceItem(type))
            );
        }
        ...
        {
            scripts.AddRange(
                widgetAttribute.ScriptFiles!.Select(src => new WidgetResourceItem(src))
            );
        }
    ...
    private static ILocalizableString GetDisplayName(
    ...
    )
    {
        ...
        return new LocalizableString(
            widgetAttribute.DisplayNameResource,
            widgetAttribute.DisplayName
        );
    }
    ...
    private WidgetDefinition WithResources(
        List<WidgetResourceItem> resourceItems,
        Type[] bundleContributorTypes
    )
    {
