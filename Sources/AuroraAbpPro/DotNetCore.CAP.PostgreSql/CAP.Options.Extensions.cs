...
public static class CapOptionsExtensions
{
    ...
    public static CapOptions UsePostgreSql(
    ...
    public static CapOptions UseEntityFramework<TContext>(
        this CapOptions options,
        Action<EFOptions> configure
    )
        where TContext : DbContext
    {
        if (configure == null)
        ...
        options.RegisterExtension(
            new PostgreSqlCapOptionsExtension(x =>
            {
                configure(x);
