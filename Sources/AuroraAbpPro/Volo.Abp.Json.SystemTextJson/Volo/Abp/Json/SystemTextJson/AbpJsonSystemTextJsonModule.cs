...
public class AbpJsonSystemTextJsonModule : AbpModule
{
    ...
    {
        context
            .Services.AddAbpOptions<AbpSystemTextJsonSerializerOptions>()
