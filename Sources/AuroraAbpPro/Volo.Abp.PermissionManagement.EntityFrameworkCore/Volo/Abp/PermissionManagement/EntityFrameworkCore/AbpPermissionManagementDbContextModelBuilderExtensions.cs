...
public static class AbpPermissionManagementDbContextModelBuilderExtensions
{
    public static void ConfigurePermissionManagement([NotNull] this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(
                AbpPermissionManagementDbProperties.DbTablePrefix + "PermissionGrants",
        ...
        {
            b.ToTable(
                AbpPermissionManagementDbProperties.DbTablePrefix + "ResourcePermissionGrants",
                AbpPermissionManagementDbProperties.DbSchema
            );
            ...
            b.Property(x => x.ResourceName)
                .HasMaxLength(PermissionGrantConsts.MaxResourceNameLength)
                .IsRequired();
            b.Property(x => x.ResourceKey)
                .HasMaxLength(PermissionGrantConsts.MaxResourceKeyLength)
                .IsRequired();
            b.Property(x => x.ProviderName)
                .HasMaxLength(PermissionGrantConsts.MaxProviderNameLength)
                .IsRequired();
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(
                    AbpPermissionManagementDbProperties.DbTablePrefix + "PermissionGroups",
                    AbpPermissionManagementDbProperties.DbSchema
                );
                ...
                b.Property(x => x.Name)
                    .HasMaxLength(PermissionGroupDefinitionRecordConsts.MaxNameLength)
                    .IsRequired();
                b.Property(x => x.DisplayName)
                    .HasMaxLength(PermissionGroupDefinitionRecordConsts.MaxDisplayNameLength)
                    .IsRequired();
            ...
            {
                b.ToTable(
                    AbpPermissionManagementDbProperties.DbTablePrefix + "Permissions",
                    AbpPermissionManagementDbProperties.DbSchema
                );
                ...
                b.Property(x => x.Name)
                    ...
                    .IsRequired();
                b.Property(x => x.ResourceName)
                    .HasMaxLength(PermissionDefinitionRecordConsts.MaxResourceNameLength);
                b.Property(x => x.ManagementPermissionName)
                    .HasMaxLength(
                        PermissionDefinitionRecordConsts.MaxManagementPermissionNameLength
                    );
