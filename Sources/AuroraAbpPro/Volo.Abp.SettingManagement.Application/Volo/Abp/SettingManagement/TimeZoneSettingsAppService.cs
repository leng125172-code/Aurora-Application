...
public class TimeZoneSettingsAppService
        ...
        ITimeZoneSettingsAppService
{
    ...
    public TimeZoneSettingsAppService(
    ...
    {
        var timezone =
            CurrentTenant.GetMultiTenancySide() == MultiTenancySides.Host
    ...
    public virtual Task<List<NameValue>> GetTimezonesAsync()
    {
        ...
        timezones.Insert(
            0,
            new NameValue { Name = L["DefaultTimeZone"], Value = UnspecifiedTimeZone }
        );
