...
namespace Hangfire.Storage
{
    ...
    {
        internal static readonly string TransactionalAcknowledgePrefix =
            "TransactionalAcknowledge:";

        public static readonly string JobQueueProperty = "Job.Queue";
        public static readonly string ExtendedApi = "Storage.ExtendedApi";
        public static readonly string ProcessesInsteadOfComponents =
            "Storage.ProcessesInsteadOfComponents";
        ...
        public static class Connection
        {
            ...
            public static readonly string BatchedGetFirstByLowest =
        ...
        public static class Transaction
        {
            ...
            private static readonly ConcurrentDictionary<Type, string> RemoveFromQueueFeatureCache =
                new();
