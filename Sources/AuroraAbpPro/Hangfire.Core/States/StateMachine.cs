...
namespace Hangfire.States
{
    ...
    public class StateMachine : IStateMachine
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage(
            ...
            Justification = "Parameter name changed to avoid ambiguity and errors in the method's implementation."
        )]
        ...
        private static void InvokeOnStateElection(
            KeyValuePair<IElectStateFilter, ElectStateContext> x
        )
        {
            try
            {
        ...
        private static void InvokeOnStateApplied(
            KeyValuePair<IApplyStateFilter, ApplyStateContext> x
        )
        {
            try
            {
        ...
        private static void InvokeOnStateUnapplied(
            KeyValuePair<IApplyStateFilter, ApplyStateContext> x
        )
        {
            try
