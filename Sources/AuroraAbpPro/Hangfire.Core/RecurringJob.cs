...
namespace Hangfire
{
    ...
    {
        private static readonly Func<RecurringJobManager> DefaultFactory = static () =>
        ...
        [Obsolete(
            "Please use an overload with the explicit recurringJobId parameter and RecurringJobOptions instead. Will be removed in 2.0.0."
        )]
        ...
        [Obsolete(
            "Please use an overload with the explicit recurringJobId parameter instead. Will be removed in 2.0.0."
        )]
        public static void AddOrUpdate(
            [NotNull, InstantHandle] Expression<Action> methodCall,
            [NotNull] Func<string> cronExpression,
        ...
        )
        {
            ...
            ManagerFactory()
                .AddOrUpdate(id, job, cronExpression, timeZone ?? TimeZoneInfo.Utc, queue);
        }
        ...
        [Obsolete(
            "Please use AddOrUpdate(string, Expression<Action>, Func<string>, RecurringJobOptions) instead. Will be removed in 2.0.0."
        )]
        public static void AddOrUpdate(
        ...
        [Obsolete(
            "Please use AddOrUpdate<T>(string, Expression<Action<T>>, Func<string>, RecurringJobOptions) instead. Will be removed in 2.0.0."
        )]
        public static void AddOrUpdate<T>(
            [NotNull] string recurringJobId,
            [NotNull, InstantHandle] Expression<Action<T>> methodCall,
        ...
        [Obsolete(
            "Please use AddOrUpdate(string, Expression<Action>, string, RecurringJobOptions) instead. Will be removed in 2.0.0."
        )]
        public static void AddOrUpdate(
            [NotNull] string recurringJobId,
            [NotNull, InstantHandle] Expression<Action> methodCall,
        ...
        [Obsolete(
            "Please use AddOrUpdate<T>(string, Expression<Action<T>>, string, RecurringJobOptions) instead. Will be removed in 2.0.0."
        )]
        public static void AddOrUpdate<T>(
            [NotNull] string recurringJobId,
            [NotNull, InstantHandle] Expression<Action<T>> methodCall,
        ...
        [Obsolete(
            "Please use AddOrUpdate(string, Expression<Func<Task>>, Func<string>, RecurringJobOptions) instead. Will be removed in 2.0.0."
        )]
        public static void AddOrUpdate(
            [NotNull] string recurringJobId,
            [NotNull, InstantHandle] Expression<Func<Task>> methodCall,
        ...
        [Obsolete(
            "Please use AddOrUpdate<T>(string, Expression<Func<T, Task>>, Func<string>, RecurringJobOptions) instead. Will be removed in 2.0.0."
        )]
        public static void AddOrUpdate<T>(
            [NotNull] string recurringJobId,
            [NotNull, InstantHandle] Expression<Func<T, Task>> methodCall,
        ...
        [Obsolete(
            "Please use AddOrUpdate(string, Expression<Func<Task>>, string, RecurringJobOptions) instead. Will be removed in 2.0.0."
        )]
        public static void AddOrUpdate(
            [NotNull] string recurringJobId,
            [NotNull, InstantHandle] Expression<Func<Task>> methodCall,
        ...
        [Obsolete(
            "Please use AddOrUpdate<T>(string, Expression<Func<T, Task>>, string, RecurringJobOptions) instead. Will be removed in 2.0.0."
        )]
        public static void AddOrUpdate<T>(
            [NotNull] string recurringJobId,
            [NotNull, InstantHandle] Expression<Func<T, Task>> methodCall,
