    ...
    public static class GlobalConfigurationExtensions
    {
            ...
            where TFilterProvider : IJobFilterProvider
        {
            ...
            return configuration.Use(
                filterProvider,
                static x => JobFilterProviders.Providers.Add(x)
            );
        }
        ...
        public static IGlobalConfiguration UseResultsInContinuations(
        ...
        )
        {
            if (configuration == null)
                throw new ArgumentNullException(nameof(configuration));
            if (numberOfLines.HasValue && numberOfLines.Value <= 1)
                throw new ArgumentOutOfRangeException(
                    nameof(numberOfLines),
                    "Must be either a positive value larger than 1; or a null value."
                );
        ...
        )
        {
            ...
            return configuration.UseFilter(
                new CaptureCultureAttribute(culture?.Name, captureDefault)
            );
        }
        ...
        )
        {
            if (configuration == null)
                throw new ArgumentNullException(nameof(configuration));
            return configuration.UseFilter(
                new CaptureCultureAttribute(culture?.Name, uiCulture?.Name)
            );
        }
        ...
        )
        {
            if (configuration == null)
                throw new ArgumentNullException(nameof(configuration));
            return configuration.UseFilter(
                new CaptureCultureAttribute(culture?.Name, uiCulture?.Name, captureDefault)
            );
        }
