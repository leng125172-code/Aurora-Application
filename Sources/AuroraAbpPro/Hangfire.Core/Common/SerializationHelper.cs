...
namespace Hangfire.Common
{
    ...
    public static class SerializationHelper
    {
        ...
        )
        {
            ...
            else
            {
                ...
                var serializerSettings =
                    option == SerializationOption.TypedInternal
        ...
        )
        {
            ...
            try
            {
                return JsonConvert.DeserializeObject(
                    value,
                    type,
                    GetSerializerSettings(SerializationOption.User)
                );
            }
        ...
        private static void SetSimpleTypeNameAssemblyFormat(
        ...
        )
        {
            ...
            var typeNameAssemblyFormatHandling = typeof(JsonSerializerSettings).GetRuntimeProperty(
                "TypeNameAssemblyFormatHandling"
            );
            var typeNameAssemblyFormat = typeof(JsonSerializerSettings).GetRuntimeProperty(
        ...
        )
        {
            switch (serializationOption)
            {
                ...
                case SerializationOption.TypedInternal:
                    return InternalSerializerSettings.Value;
                case SerializationOption.User:
                    return GetUserSerializerSettings();
                default:
                    throw new ArgumentOutOfRangeException(
                        nameof(serializationOption),
                        serializationOption,
                        null
                    );
            }
