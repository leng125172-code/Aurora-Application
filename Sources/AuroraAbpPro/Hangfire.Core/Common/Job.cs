...
namespace Hangfire.Common
{
    ...
    public partial class Job
    {
        ...
        public Job(
            ...
            [NotNull] IReadOnlyList<object> args
        )
            : this(type, method, args, null) { }
        ...
        public static Job FromExpression<TType>(
            [NotNull, InstantHandle] Expression<Action<TType>> methodCall
        )
        {
            return FromExpression(methodCall, null);
        }
        ...
        /// </remarks>
        public static Job FromExpression<TType>(
            [NotNull, InstantHandle] Expression<Func<TType, Task>> methodCall
        )
        {
            return FromExpression(methodCall, null);
        }
        ...
        private static Job FromExpression(
            [NotNull] LambdaExpression methodCall,
        ...
        )
        {
            ...
            if (
                ...
                && AsyncStateMachineAttributeCache.GetOrAdd(
                    method,
                    static m => m.GetCustomAttribute<AsyncStateMachineAttribute>()
                ) != null
            )
            {
                throw new NotSupportedException(
            ...
            foreach (var parameter in parameters)
            {
                ...
                if (
                    parameterTypeInfo.IsSubclassOf(typeof(Delegate))
                    || parameterTypeInfo.IsSubclassOf(typeof(Expression))
                )
                {
                    throw new NotSupportedException(
