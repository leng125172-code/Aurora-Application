...
namespace Hangfire.Common
{
    ...
    internal readonly struct JobFilterInfo
    {
        ...
        public JobFilterInfo(IEnumerable<JobFilter> filters)
        {
            ...
            ClientExceptionFiltersReversed = new ReversedFilterCollection<IClientExceptionFilter>(
                filtersList
            );
            ServerExceptionFiltersReversed = new ReversedFilterCollection<IServerExceptionFilter>(
                filtersList
            );
        }
