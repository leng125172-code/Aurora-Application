...
namespace Hangfire.Common
{
    ...
    {
        [Obsolete(
            "Please use `GlobalConfiguration.UseSerializerSettings` instead. Will be removed in 2.0.0"
        )]
        ...
        [Obsolete(
            "Please use `SerializationHelper.Serialize` with appropriate serialization option instead. Will be removed in 2.0.0"
        )]
        ...
        [Obsolete(
            "Please use `SerializationHelper.Deserialize` with appropriate serialization option instead. Will be removed in 2.0.0"
        )]
        ...
        private static readonly DateTime MillisecondTimestampBoundaryDate = new DateTime(
            1978,
            1,
            11,
            21,
        ...
        {
            if (
                value > MillisecondTimestampBoundaryDate
