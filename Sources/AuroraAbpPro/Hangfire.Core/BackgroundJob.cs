...
namespace Hangfire
{
    ...
    {
        private static readonly Func<IBackgroundJobClient> DefaultFactory = static () =>
        ...
        /// <returns>Unique identifier of a created job.</returns>
        [Obsolete(
            "Deprecated for clarity, please use ContinueJobWith method with the same arguments. Will be removed in 2.0.0."
        )]
