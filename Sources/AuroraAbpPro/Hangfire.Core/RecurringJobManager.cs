...
namespace Hangfire
{
    ...
    public class RecurringJobManager : IRecurringJobManager, IRecurringJobManagerV2
    {
        ...
        )
        {
            ...
            _timeZoneResolver =
                timeZoneResolver ?? throw new ArgumentNullException(nameof(timeZoneResolver));
        ...
        )
        {
            ...
            using (connection.AcquireDistributedRecurringJobLock(recurringJobId, DefaultTimeout))
            {
                ...
                if (
                    !options.TimeZone.Id.Equals(
                        recurringJob.TimeZoneId,
...
#pragma warning restore 618
        ...
        public string TriggerJob(string recurringJobId)
        {
            ...
            using (connection.AcquireDistributedRecurringJobLock(recurringJobId, DefaultTimeout))
            {
                ...
                try
                {
                    backgroundJob = _factory.TriggerRecurringJob(
                        _storage,
                        connection,
