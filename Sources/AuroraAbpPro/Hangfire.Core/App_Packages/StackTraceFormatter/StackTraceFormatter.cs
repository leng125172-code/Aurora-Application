...
namespace Hangfire
{
    ...
    partial class StackTraceHtmlFragments : IStackTraceFormatter<string>
    {
        ...
        string IStackTraceFormatter<string>.Method(string markup) =>
            BeforeMethod + markup + AfterMethod;
    ...
    {
        static readonly StackTraceHtmlFragments DefaultStackTraceHtmlFragments =
        ...
        public static IEnumerable<T> Format<T>(string text, IStackTraceFormatter<T> formatter)
        {
                ...
                (t, m) =>
                    new
                    {
                        Type = new
                        {
                            t.Index,
                            t.End,
                            Markup = formatter.Type(t.Markup),
                        },
                        Method = new
                        {
                            m.Index,
                            m.End,
                            Markup = formatter.Method(m.Markup),
                        },
                    },
                (t, n) =>
                    new
                    {
                        Type = new
                        {
                            t.Index,
                            t.End,
                            Markup = formatter.ParameterType(t.Markup),
                        },
                        Name = new
                        {
                            n.Index,
                            n.End,
                            Markup = formatter.ParameterName(n.Markup),
                        },
                    },
                    ...
                    new
                    {
                        File = f.Text.Length > 0
                            ? new
                            {
                                f.Index,
                                f.End,
                                Markup = formatter.File(f.Markup),
                            }
                            : null,
                        Line = l.Text.Length > 0
                            ? new
                            {
                                l.Index,
                                l.End,
                                Markup = formatter.Line(l.Markup),
                            }
                            : null,
                    },
                (f, tm, p, fl) =>
                    from tokens in new[]
                    {
                        new[]
                        {
                            ...
                            new
                            {
                                p.List.Index,
                                End = p.List.Index,
                                Markup = formatter.BeforeParameters,
                            },
                        },
                        ...
                        new[]
                        {
                            new
                            {
                                Index = p.List.End,
                                p.List.End,
                                Markup = formatter.AfterParameters,
                            },
                            fl.File,
                            fl.Line,
                            new
            ...
            return from token in Enumerable
                    .Repeat(
                        new
                        {
                            Index = 0,
