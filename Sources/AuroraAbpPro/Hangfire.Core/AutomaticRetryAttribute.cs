...
namespace Hangfire
{
    ...
    public sealed class AutomaticRetryAttribute
        : JobFilterAttribute,
            IElectStateFilter,
            IApplyStateFilter
    {
        ...
        {
            if (
                context.NewState is ScheduledState
                && context.NewState.Reason != null
                && context.NewState.Reason.StartsWith(
                    "Retry attempt",
        ...
        )
        {
            ...
            {
                delayInSeconds =
                    retryAttempt <= _delaysInSeconds.Length
            ...
            var exceptionMessage =
                failedState.Exception.Message.Length > maxMessageLength
