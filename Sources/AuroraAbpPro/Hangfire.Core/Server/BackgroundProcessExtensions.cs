    ...
    public static class BackgroundProcessExtensions
    {
        ...
        )
        {
            ...
            return UseBackgroundPool(
                process,
                (threadName, threadStart) =>
                    DefaultThreadFactory(threadCount, threadName, threadStart, threadConfig)
            );
        }
        ...
        )
        {
            ...
            return UseBackgroundPool(
                ...
                maxConcurrency,
                (threadName, threadStart) =>
                    DefaultThreadFactory(threadCount, threadName, threadStart, null)
            );
        }
        ...
        )
        {
            ...
            Func<TaskScheduler> createScheduler = () =>
                new BackgroundTaskScheduler(
                    threadStart => threadFactory(process.GetType().Name, threadStart),
                    static exception =>
                    {
                        LogProvider
                            .GetLogger(typeof(BackgroundTaskScheduler))
                            .FatalException(
            ...
            return new BackgroundProcessDispatcherBuilderAsync(
                process,
                createScheduler,
                maxConcurrency,
                true
