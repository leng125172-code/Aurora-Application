...
namespace Hangfire.Server
{
        ...
        : IBackgroundProcessDispatcherBuilder
    {
        ...
        public IBackgroundDispatcher Create(
            BackgroundServerContext context,
            BackgroundProcessingServerOptions options
        )
        {
            if (context == null)
        ...
        {
            var tuple =
                (Tuple<IBackgroundProcessAsync, BackgroundServerContext, BackgroundExecution>)state;
