...
namespace Hangfire.Server
{
    public class BackgroundProcessContext
    {
        ...
        public bool IsStopping =>
            ...
            || StoppedToken.IsCancellationRequested
            || ShutdownToken.IsCancellationRequested;
        public bool IsStopped =>
            StoppedToken.IsCancellationRequested || ShutdownToken.IsCancellationRequested;

        [Obsolete(
            "Please use IsStopping or IsStopped properties instead. Will be removed in 2.0.0."
        )]
