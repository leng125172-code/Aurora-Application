...
namespace Hangfire
{
    public class BackgroundJobServerOptions
    {
            ...
            set
            {
                ...
                if (value.Length == 0)
                    throw new ArgumentException(
                        "You should specify at least one queue to listen.",
                        nameof(value)
                    );
        ...
        public TimeSpan StopTimeout
        {
            ...
            set
            {
                ...
                )
                {
                    throw new ArgumentOutOfRangeException(
                        nameof(value),
                        $"StopTimeout must be either equal to or less than {Int32.MaxValue} milliseconds and non-negative or infinite"
                    );
                }
                _stopTimeout = value;
            }
        ...
        [Obsolete(
            "Please use `ServerTimeout` or `ServerCheckInterval` options instead. Will be removed in 2.0.0."
        )]
