    ...
    public class JobParameterInjectionFilter : IServerFilter
    {
        ...
        public void OnPerforming(PerformingContext context)
        {
            ...
            for (var index = 0; index < parameters.Length; index++)
            {
                ...
                var serialized = context.Connection.GetJobParameter(
                ...
                if (serialized != null)
                {
                    ...
                    if (
                        parameterType == typeof(ExceptionInfo)
                        && DefaultException.Equals(serialized, StringComparison.Ordinal)
                    )
                    {
                    ...
                    {
                        deserialized = SerializationHelper.Deserialize(
                            serialized,
                            parameterType,
