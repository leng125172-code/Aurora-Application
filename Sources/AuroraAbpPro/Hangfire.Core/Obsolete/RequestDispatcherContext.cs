...
namespace Hangfire.Dashboard
{
    ...
    public class RequestDispatcherContext
    {
        ...
        )
        {
            ...
            if (uriMatch == null)
                throw new ArgumentNullException(nameof(uriMatch));
        ...
        public static RequestDispatcherContext FromDashboardContext(
        ...
        )
        {
            ...
            if (owinContext == null)
            {
                throw new NotSupportedException(
                    $"context must be of type '{nameof(OwinDashboardContext)}'"
                );
            }
