...
namespace Hangfire
{
    ...
    public interface IBootstrapperConfiguration
    {
        ...
        [Obsolete(
            "Please use `IAppBuilder.UseHangfireDashboard(\"/hangfire\", new DashboardOptions { AuthorizationFilters = filters })` OWIN extension method instead. Will be removed in version 2.0.0."
        )]
        ...
        [Obsolete(
            "Please use `GlobalConfiguration.UseFilter` instead. Will be removed in version 2.0.0."
        )]
        ...
        [Obsolete(
            "Please use `IAppBuilder.UseHangfireDashboard(string pathMatch)` OWIN extension method instead. Will be removed in version 2.0.0."
        )]
        ...
        [Obsolete(
            "Please use `IAppBuilder.UseHangfireDashboard(\"/hangfire\", new DashboardOptions { AppPath = path })` OWIN extension method instead. Will be removed in version 2.0.0."
        )]
        ...
        [Obsolete(
            "Please use `GlobalConfiguration.UseStorage` instead. Will be removed in version 2.0.0."
        )]
        ...
        [Obsolete(
            "Please use `GlobalConfiguration.UseActivator` instead. Will be removed in version 2.0.0."
        )]
        ...
        [Obsolete(
            "Please use `IAppBuilder.UseHangfireServer` OWIN extension method instead. Will be removed in version 2.0.0."
        )]
