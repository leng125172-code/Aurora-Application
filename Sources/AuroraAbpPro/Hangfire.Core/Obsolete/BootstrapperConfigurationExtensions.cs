...
namespace Hangfire
{
    ...
    public static class BootstrapperConfigurationExtensions
    {
        ...
        public static void UseServer(this IBootstrapperConfiguration configuration, int workerCount)
        {
            var options = new BackgroundJobServerOptions { WorkerCount = workerCount };
        ...
        {
            var options = new BackgroundJobServerOptions { Queues = queues };
        ...
        )
        {
            configuration.UseServer(() =>
                new BackgroundJobServer(new BackgroundJobServerOptions(), storage)
            );
        }
