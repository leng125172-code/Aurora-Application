...
public static class BasicManagementErrorCodes
{
    ...
    public const string CodeIsNotValid = BasicManagementConsts.NameSpace + ":100008";
    public const string TwoFactorCodeNull = BasicManagementConsts.NameSpace + ":100009";
    public const string TwoFactorSecretNull = BasicManagementConsts.NameSpace + ":100010";
    public const string UnknownExternalLoginProvider = BasicManagementConsts.NameSpace + ":100011";
