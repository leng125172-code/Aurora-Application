...
[ExposeServices(
    ...
    typeof(IHasParentTelemetryActivityEventEnricher<TelemetryApplicationInfoEnricher>)
)]
public sealed class TelemetryPermissionInfoEnricher
    : TelemetryActivityEventEnricher,
        IHasParentTelemetryActivityEventEnricher<TelemetryApplicationInfoEnricher>
{
    private readonly IPermissionDefinitionManager _permissionDefinitionManager;

    public TelemetryPermissionInfoEnricher(
    ...
    protected override async Task ExecuteAsync(ActivityContext context)
    {
    ...
    {
        return permission.Properties.TryGetValue(
                PermissionDefinitionContext.KnownPropertyNames.CurrentProviderName,
