        ...
        ISingletonDependency
{
    ...
    protected IStaticDefinitionCache<
    ...
    )
    {
        ...
        return resourcePermissions.FirstOrDefault(p =>
    ...
    )> GetPermissionGroupDefinitionsAsync()
    {
    ...
    protected virtual Task<(
        Dictionary<string, PermissionGroupDefinition>,
        List<PermissionDefinition>
    )> CreatePermissionGroupDefinitionsAsync()
    {
        using (var scope = ServiceProvider.CreateScope())
        {
            ...
            var providers = Options
                .DefinitionProviders.Select(p =>
                    (scope.ServiceProvider.GetRequiredService(p) as IPermissionDefinitionProvider)!
                )
                .ToList();
    ...
    protected virtual async Task<
        Dictionary<string, PermissionDefinition>
    > CreatePermissionDefinitionsAsync()
    {
