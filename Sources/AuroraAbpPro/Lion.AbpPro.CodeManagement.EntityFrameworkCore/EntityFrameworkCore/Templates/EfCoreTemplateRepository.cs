...
public class EfCoreTemplateRepository
    : EfCoreRepository<ICodeManagementDbContext, Template, Guid>,
        ITemplateRepository
{
    public EfCoreTemplateRepository(IDbContextProvider<ICodeManagementDbContext> dbContextProvider)
    ...
    public async Task<Template> FindByNameExcludeIdAsync(
        string name,
        Guid id,
