        ...
        IIdentitySecurityLogAppService
{
    ...
    public virtual async Task<PagedResultDto<PagingIdentitySecurityLogOutput>> GetListAsync(
        PagingIdentitySecurityLogInput input
    )
    {
        ...
        return new PagedResultDto<PagingIdentitySecurityLogOutput>(
            totalCount,
            list.Adapt<List<PagingIdentitySecurityLogOutput>>()
        );
    }
}
