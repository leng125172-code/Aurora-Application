...
public abstract class ResourcePermissionManagementProvider : IResourcePermissionManagementProvider
{
    ...
    public virtual async Task<ResourcePermissionValueProviderGrantInfo> CheckAsync(
        string name,
        string resourceName,
        string resourceKey,
        string providerName,
    ...
    {
        var multiplePermissionValueProviderGrantInfo = await CheckAsync(
            new[] { name },
            resourceName,
            resourceKey,
            providerName,
    ...
    public virtual async Task<MultipleResourcePermissionValueProviderGrantInfo> CheckAsync(
        string[] names,
        string resourceName,
        string resourceKey,
        string providerName,
    ...
    )
    {
        using (ResourcePermissionGrantRepository.DisableTracking())
        {
            var multiplePermissionValueProviderGrantInfo =
                new MultipleResourcePermissionValueProviderGrantInfo(names);
            if (providerName != Name)
            {
                return multiplePermissionValueProviderGrantInfo;
            }

            var resourcePermissionGrants = await ResourcePermissionGrantRepository.GetListAsync(
                names,
                resourceName,
                resourceKey,
                providerName,
            ...
            foreach (var permissionName in names)
            {
                ...
                multiplePermissionValueProviderGrantInfo.Result[permissionName] =
                    new ResourcePermissionValueProviderGrantInfo(isGrant, providerKey);
            }
    ...
    {
        var resourcePermissionGrants = await ResourcePermissionGrantRepository.FindAsync(
            name,
            resourceName,
            resourceKey,
            Name,
        ...
        resourcePermissionGrants = new ResourcePermissionGrant(
    ...
    protected virtual async Task RevokeAsync(
        string name,
        string resourceName,
        string resourceKey,
        string providerKey
