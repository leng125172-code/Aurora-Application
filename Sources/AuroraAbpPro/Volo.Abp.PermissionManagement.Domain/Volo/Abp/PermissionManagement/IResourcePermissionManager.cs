...
public interface IResourcePermissionManager
{
    ...
    Task<IResourcePermissionProviderKeyLookupService> GetProviderKeyLookupServiceAsync(
        string providerName
    );
    ...
    Task<List<PermissionWithGrantedProviders>> GetAllAsync(string resourceName, string resourceKey);
