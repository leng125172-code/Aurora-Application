...
{
    public static ResourcePermissionValueProviderGrantInfo NonGranted { get; } =
        new ResourcePermissionValueProviderGrantInfo(false);

    public virtual bool IsGranted { get; set; }

    public virtual string ProviderKey { get; set; }

    public ResourcePermissionValueProviderGrantInfo(
        bool isGranted,
