...
[Route("Projects")]
public class ProjectController : CodeManagementController, IProjectAppService
{
    ...
    [HttpPost("GetProjectAndEntity")]
    [SwaggerOperation(summary: "获取项目和实体信息", Tags = new[] { "Projects" })]
    public Task<GetProjectAndEntityOutput> GetProjectAndEntityAsync(GetProjectAndEntityInput input)
    {
        return _projectAppService.GetProjectAndEntityAsync(input);
    }
}
