...
using Lion.AbpPro.CodeManagement.EntityModels.Dto;

namespace Lion.AbpPro.CodeManagement;

[Route("EntityModels")]
public class EntityModelController : CodeManagementController, IEntityModelAppService
{
    ...
    public Task<PagedResultDto<PageEntityModelPropertyOutput>> PagePropertyAsync(
