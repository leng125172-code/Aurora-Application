    ...
    private static void OverrideDefaultSettings(ISettingDefinitionContext context)
    {
        context.Add(
            new SettingDefinition(
                ...
                .WithProperty(
                    BasicManagementSettings.Group.Default,
        ...
        context
            .GetOrNull(IdentitySettingNames.Password.RequiredLength)
            .WithProperty(
                BasicManagementSettings.Group.Default,
                BasicManagementSettings.Group.SystemManagement
            )
        ...
        context
            .GetOrNull(IdentitySettingNames.Password.RequiredUniqueChars)
            .WithProperty(
                BasicManagementSettings.Group.Default,
                BasicManagementSettings.Group.SystemManagement
            )
        ...
        context
            .GetOrNull(IdentitySettingNames.Password.RequireNonAlphanumeric)
            .WithProperty(
                BasicManagementSettings.Group.Default,
                BasicManagementSettings.Group.SystemManagement
            )
        ...
        context
            .GetOrNull(IdentitySettingNames.Password.RequireLowercase)
            .WithProperty(
                BasicManagementSettings.Group.Default,
                BasicManagementSettings.Group.SystemManagement
            )
        ...
        context
            .GetOrNull(IdentitySettingNames.Password.RequireUppercase)
            .WithProperty(
                BasicManagementSettings.Group.Default,
                BasicManagementSettings.Group.SystemManagement
            )
        ...
        context
            .GetOrNull(IdentitySettingNames.Password.RequireDigit)
            .WithProperty(
                BasicManagementSettings.Group.Default,
                BasicManagementSettings.Group.SystemManagement
            )
        ...
        context
            .GetOrNull(IdentitySettingNames.Lockout.LockoutDuration)
            .WithProperty(
                BasicManagementSettings.Group.Default,
                BasicManagementSettings.Group.SystemManagement
            )
        ...
        context
            .GetOrNull(IdentitySettingNames.Lockout.MaxFailedAccessAttempts)
            .WithProperty(
                BasicManagementSettings.Group.Default,
                BasicManagementSettings.Group.SystemManagement
            )
        ...
        context.Add(
            new SettingDefinition(
                BasicManagementSettings.EnableNewAccountRequiredChangePassword,
                "false",
        ...
        context.Add(
            new SettingDefinition(
                BasicManagementSettings.EnableExpireRequiredChangePassword,
                "false",
        ...
        context.Add(
            new SettingDefinition(
                BasicManagementSettings.PasswordExpireDay,
                "90",
        ...
        context.Add(
            new SettingDefinition(
                BasicManagementSettings.PasswordRemindDay,
                "7",
