...
public interface IAbpCommonDbContextRegistrationOptionsBuilder
{
    ...
    /// Set <paramref name="includeAllEntities"/> to true to include all entities.
    /// </param>
    IAbpCommonDbContextRegistrationOptionsBuilder AddDefaultRepositories<TDefaultRepositoryDbContext>(
        bool includeAllEntities = false
    );
    ...
    /// <returns></returns>
    IAbpCommonDbContextRegistrationOptionsBuilder SetDefaultRepositoryClasses(
    ...
    /// <param name="multiTenancySides">MultiTenancy side</param>
    IAbpCommonDbContextRegistrationOptionsBuilder ReplaceDbContext<
        TOtherDbContext,
        TTargetDbContext
    >(MultiTenancySides multiTenancySides = MultiTenancySides.Both);
