...
public static class EntityHelper
{
    ...
    public static bool EntityEquals(IEntity? entity1, IEntity? entity2)
    {
        ...
        if (
            !typeOfEntity1.IsAssignableFrom(typeOfEntity2)
    ...
    public static Func<Type, bool> IsValueObjectPredicate = type =>
    ...
    public static Expression<Func<TEntity, bool>> CreateEqualityExpressionForId<TEntity, TKey>(
        TKey id
    )
