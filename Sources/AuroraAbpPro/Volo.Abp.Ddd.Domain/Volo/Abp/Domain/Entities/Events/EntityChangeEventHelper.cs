...
public class EntityChangeEventHelper : IEntityChangeEventHelper, ITransientDependency
{
    ...
    )
    {
        ...
        var eventRecord = new UnitOfWorkEventRecord(
            eventType,
            eventData,
    ...
    public bool IsSameEntityEventRecord(
    ...
    )
    {
        ...
        var record1OriginalEntity =
            record1.Properties.GetOrDefault(UnitOfWorkEventRecordEntityPropName) as IEntity;
        var record2OriginalEntity =
            record2.Properties.GetOrDefault(UnitOfWorkEventRecordEntityPropName) as IEntity;
