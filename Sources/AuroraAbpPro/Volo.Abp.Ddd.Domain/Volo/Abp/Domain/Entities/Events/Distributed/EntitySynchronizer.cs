    ...
    where TEntity : class, IEntity
{
    ...
    protected virtual async Task<bool> TryCreateOrUpdateEntityAsync(TSourceEntityEto eto)
    {
        ...
        if (localEntity == null)
        {
            ...
            if (
                localEntity is IHasEntityVersion versionedLocalEntity
                && eto is IHasEntityVersion versionedEto
            )
            {
    ...
    protected virtual Task<bool> IsEtoNewerAsync(TSourceEntityEto eto, TEntity? localEntity)
    {
        ...
        )
        {
            ...
            return Task.FromResult(
                versionedEto.EntityVersion >= versionedLocalEntity.EntityVersion
            );
        }
