...
public static class RepositoryAsyncExtensions
{
    ...
    {
        var queryable = await repository.GetQueryableAsync();
        return await repository.AsyncExecuter.LongCountAsync(
            queryable,
            predicate,
            cancellationToken
        );
    ...
    {
        var queryable = AddOrderById(await repository.GetQueryableAsync());
        return await repository.AsyncExecuter.FirstOrDefaultAsync(
            queryable,
            predicate,
            cancellationToken
        );
    ...
    {
        var queryable = AddOrderById(await repository.GetQueryableAsync());
        return await repository.AsyncExecuter.LastOrDefaultAsync(
            queryable,
            predicate,
            cancellationToken
        );
    ...
    {
        var queryable = await repository.GetQueryableAsync();
        return await repository.AsyncExecuter.SingleOrDefaultAsync(
            queryable,
            predicate,
            cancellationToken
        );
