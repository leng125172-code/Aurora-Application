...
public class StaticTemplateDefinitionStore : IStaticTemplateDefinitionStore, ISingletonDependency
{
    ...
    protected IStaticDefinitionCache<
        TemplateDefinition,
        Dictionary<string, TemplateDefinition>
    > DefinitionCache { get; }
    ...
    protected virtual Task<
        Dictionary<string, TemplateDefinition>
    > CreateTextTemplateDefinitionsAsync()
    {
        ...
        using (var scope = ServiceProvider.CreateScope())
        {
            var providers = Options
                .DefinitionProviders.Select(p =>
                    (scope.ServiceProvider.GetRequiredService(p) as ITemplateDefinitionProvider)!
                )
                .ToList();
