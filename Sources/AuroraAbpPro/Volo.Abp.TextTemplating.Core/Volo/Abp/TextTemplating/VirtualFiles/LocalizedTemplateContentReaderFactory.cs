...
public class LocalizedTemplateContentReaderFactory
        ...
        ISingletonDependency
{
    ...
    public LocalizedTemplateContentReaderFactory(
    ...
    public virtual async Task<ILocalizedTemplateContentReader> CreateAsync(
        ...
        if (!fileInfo.Exists)
        {
            ...
            if (!directoryContents.Exists)
            {
                throw new AbpException(
                    "Could not find a file/folder at the location: " + virtualPath
                );
            }

            fileInfo = new VirtualDirectoryFileInfo(
                virtualPath,
                virtualPath,
