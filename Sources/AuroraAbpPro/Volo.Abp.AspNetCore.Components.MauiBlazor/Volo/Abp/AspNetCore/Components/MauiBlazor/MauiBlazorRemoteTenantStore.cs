...
public class MauiBlazorRemoteTenantStore : ITenantStore, ITransientDependency
{
    ...
    public MauiBlazorRemoteTenantStore(
    ...
    public TenantConfiguration? Find(Guid id)
    {
        ...
        var tenantConfiguration = Cache.GetOrAdd(
            ...
            () =>
                AsyncHelper.RunSync(async () =>
                    CreateTenantConfiguration(await TenantAppService.FindTenantByIdAsync(id))
                )!,
            () =>
                new DistributedCacheEntryOptions
                {
    ...
    protected virtual TenantConfiguration? CreateTenantConfiguration(
    ...
    )
    {
        ...
        return new TenantConfiguration(
            tenantResultDto.TenantId.Value,
            tenantResultDto.Name!,
            tenantResultDto.NormalizedName!
        );
    }
