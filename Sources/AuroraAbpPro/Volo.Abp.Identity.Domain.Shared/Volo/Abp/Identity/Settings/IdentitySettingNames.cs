...
public static class IdentitySettingNames
{
    ...
    public static class Password
    {
        ...
        public const string ForceUsersToPeriodicallyChangePassword =
            PasswordPrefix + ".ForceUsersToPeriodicallyChangePassword";
        public const string PasswordChangePeriodDays = PasswordPrefix + ".PasswordChangePeriodDays";
        public const string EnablePreventPasswordReuse =
            PasswordPrefix + ".EnablePreventPasswordReuse";
        public const string PreventPasswordReuseCount =
            PasswordPrefix + ".PreventPasswordReuseCount";
    }
    ...
    public static class SignIn
    {
        ...
        public const string RequireEmailVerificationToRegister =
            SignInPrefix + ".RequireEmailVerificationToRegister";
        public const string EnablePhoneNumberConfirmation =
            SignInPrefix + ".EnablePhoneNumberConfirmation";
        public const string RequireConfirmedPhoneNumber =
            SignInPrefix + ".RequireConfirmedPhoneNumber";
    }
    ...
    public static class OrganizationUnit
    {
        ...
        public const string MaxUserMembershipCount =
            OrganizationUnitPrefix + ".MaxUserMembershipCount";
    }
}
