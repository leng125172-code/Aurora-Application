        ...
        IAuditLogRepository
{
    ...
    )
    {
        ...
        var auditLogs = await query
            .OrderBy(
                sorting.IsNullOrWhiteSpace() ? (nameof(AuditLog.ExecutionTime) + " DESC") : sorting
            )
    ...
    )
    {
        ...
        return (await GetDbSetAsync())
            ...
            .WhereIf(
                hasException.HasValue && hasException.Value,
            ...
            .WhereIf(
                !url.IsNullOrEmpty(),
                auditLog => auditLog.Url != null && auditLog.Url.Contains(url)
            )
            ...
            .WhereIf(
                ...
                auditLog => auditLog.ApplicationName == applicationName
            )
            .WhereIf(
                !clientIpAddress.IsNullOrEmpty(),
                auditLog =>
                    auditLog.ClientIpAddress != null && auditLog.ClientIpAddress == clientIpAddress
            )
            .WhereIf(
                !correlationId.IsNullOrEmpty(),
                auditLog => auditLog.CorrelationId == correlationId
            )
            .WhereIf(
            ...
            .WhereIf(
                maxExecutionDuration != null && maxExecutionDuration.Value > 0,
                auditLog => auditLog.ExecutionDuration <= maxExecutionDuration
            )
            .WhereIf(
                minExecutionDuration != null && minExecutionDuration.Value > 0,
