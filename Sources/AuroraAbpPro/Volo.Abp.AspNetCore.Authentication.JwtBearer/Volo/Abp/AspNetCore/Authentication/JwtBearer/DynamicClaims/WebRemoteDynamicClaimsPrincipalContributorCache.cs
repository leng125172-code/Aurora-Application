        ...
        try
        {
            if (HttpContextAccessor.HttpContext == null)
            {
                throw new AbpException(
                    $"Failed to refresh remote claims for user: {userId} - HttpContext is null!"
                );
            }
            ...
            {
                throw new AbpException(
                    $"Failed to refresh remote claims for user: {userId} - authentication failed!"
                );
            }
            ...
            {
                throw new AbpException(
                    $"Failed to refresh remote claims for user: {userId} - access_token is null or empty!"
                );
            }
