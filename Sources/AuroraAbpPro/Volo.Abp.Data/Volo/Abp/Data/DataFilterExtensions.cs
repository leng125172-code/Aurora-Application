...
public static class DataFilterExtensions
{
    ...
    public static IDisposable Disable<T1, T2>(this IDataFilter filter)
        ...
        where T2 : class
    {
        return new CompositeDisposable(new[] { filter.Disable<T1>(), filter.Disable<T2>() });
    }
        ...
        where T3 : class
    {
        return new CompositeDisposable(
            new[] { filter.Disable<T1>(), filter.Disable<T2>(), filter.Disable<T3>() }
        );
    }
    ...
    public static IDisposable Enable<T1, T2>(this IDataFilter filter)
        ...
        where T2 : class
    {
        return new CompositeDisposable(new[] { filter.Enable<T1>(), filter.Enable<T2>() });
    }
    ...
    {
        return new CompositeDisposable(
            new[] { filter.Enable<T1>(), filter.Enable<T2>(), filter.Enable<T3>() }
        );
    }
