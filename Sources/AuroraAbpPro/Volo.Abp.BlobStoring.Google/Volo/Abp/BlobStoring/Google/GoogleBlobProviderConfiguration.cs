...
public class GoogleBlobProviderConfiguration
{
    ...
    public string? ProjectId
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(
                GoogleBlobProviderConfigurationNames.ProjectId
            );
        set =>
    ...
    public string? ClientEmail
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(
                GoogleBlobProviderConfigurationNames.ClientEmail
            );
        set =>
            _containerConfiguration.SetConfiguration(
                GoogleBlobProviderConfigurationNames.ClientEmail,
    ...
    public string? PrivateKey
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(
                GoogleBlobProviderConfigurationNames.PrivateKey
            );
        set =>
            _containerConfiguration.SetConfiguration(
                GoogleBlobProviderConfigurationNames.PrivateKey,
    ...
    public List<string>? Scopes
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                GoogleBlobProviderConfigurationNames.Scopes,
                new List<string>()
            );
        set =>
            _containerConfiguration.SetConfiguration(
    ...
    public bool UseApplicationDefaultCredentials
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                GoogleBlobProviderConfigurationNames.UseApplicationDefaultCredentials,
                false
            );
        set =>
            _containerConfiguration.SetConfiguration(
    ...
    public string? ContainerName
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(
                GoogleBlobProviderConfigurationNames.ContainerName
            );
        set =>
            _containerConfiguration.SetConfiguration(
                GoogleBlobProviderConfigurationNames.ContainerName,
    ...
    public bool CreateContainerIfNotExists
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                GoogleBlobProviderConfigurationNames.CreateContainerIfNotExists,
                false
            );
        set =>
            _containerConfiguration.SetConfiguration(
