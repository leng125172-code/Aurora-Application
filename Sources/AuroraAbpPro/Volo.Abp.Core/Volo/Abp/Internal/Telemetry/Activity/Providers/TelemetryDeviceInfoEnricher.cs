...
internal sealed class TelemetryDeviceInfoEnricher : TelemetryActivityEventEnricher
{
    ...
    public TelemetryDeviceInfoEnricher(
    ...
    protected override async Task ExecuteAsync(ActivityContext context)
    {
        try
        {
            ...
            context.Current[ActivityPropertyNames.DeviceLanguage] = CultureInfo
                .CurrentUICulture
                .Name;
            ...
            context.Current[ActivityPropertyNames.OperatingSystemArchitecture] =
