...
public abstract class TelemetryActivityEventEnricher
    : ITelemetryActivityEventEnricher,
        IScopedDependency
{
    ...
    private ITelemetryActivityEventEnricher[] GetChildren(IServiceProvider serviceProvider)
    {
        ...
        var genericInterfaceType =
            typeof(IHasParentTelemetryActivityEventEnricher<>).MakeGenericType(targetType);
        ...
        return childServices.Cast<ITelemetryActivityEventEnricher>().ToArray();
    }
}
