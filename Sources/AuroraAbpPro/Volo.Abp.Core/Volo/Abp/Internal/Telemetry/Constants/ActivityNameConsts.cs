...
public static class ActivityNameConsts
{
    ...
    public const string AbpStudioSolutionAddModuleStandard =
        "AbpStudio.Solution.Add.Module.Standard";
    ...
    public const string AbpStudioSolutionAddPackageHttpApiLayer =
        "AbpStudio.Solution.Add.Package.HttpApiLayer";
    ...
    public const string AbpStudioSolutionRunnerAddCsharpApp =
        "AbpStudio.SolutionRunner.Add.CsharpApp";
    ...
    public const string AbpStudioSolutionRunnerAppManageMetadata =
        "AbpStudio.SolutionRunner.App.Manage.Metadata";
    public const string AbpStudioSolutionRunnerAppManageSecrets =
        "AbpStudio.SolutionRunner.App.Manage.Secrets";
    ...
    public const string AbpStudioMonitoringHttpRequestsDetail =
        "AbpStudio.Monitoring.HttpRequests.Detail";
    ...
    public const string AbpStudioMonitoringExceptionsDetail =
        "AbpStudio.Monitoring.Exceptions.Detail";
    ...
    public const string AbpStudioKubernetesHelmCommandsInstall =
        "AbpStudio.Kubernetes.Helm.Commands.Install";
    public const string AbpStudioKubernetesHelmCommandsBuildImages =
        "AbpStudio.Kubernetes.Helm.Commands.BuildImages";
    public const string AbpStudioKubernetesHelmChartsRefreshSubCharts =
        "AbpStudio.Kubernetes.Helm.Charts.RefreshSubCharts";
    public const string AbpStudioKubernetesHelmChartsManageMetadata =
        "AbpStudio.Kubernetes.Helm.Charts.Manage.Metadata";
