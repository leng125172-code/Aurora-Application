...
{
    public static IStringLocalizer? CreateDefaultOrNull(
        this IStringLocalizerFactory localizerFactory
    )
    {
        return (localizerFactory as IAbpStringLocalizerFactory)?.CreateDefaultOrNull();
    }
    ...
    {
        return (localizerFactory as IAbpStringLocalizerFactory)?.CreateByResourceNameOrNull(
            resourceName
        );
    }
    ...
    )
    {
        ...
        if (localizer == null)
        {
            throw new AbpException(
                "Couldn't find a localizer with given resource name: " + resourceName
            );
        }
    ...
    [NotNull]
    public static async Task<IStringLocalizer> CreateByResourceNameAsync(
        this IStringLocalizerFactory localizerFactory,
        string resourceName
    )
    {
