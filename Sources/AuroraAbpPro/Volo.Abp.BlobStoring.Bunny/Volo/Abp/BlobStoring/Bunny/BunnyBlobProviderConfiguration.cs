...
public class BunnyBlobProviderConfiguration
{
    public string? Region
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                BunnyBlobProviderConfigurationNames.Region,
                "de"
            );
        set =>
    ...
    public string? ContainerName
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(
                BunnyBlobProviderConfigurationNames.ContainerName
            );
        set =>
            _containerConfiguration.SetConfiguration(
                BunnyBlobProviderConfigurationNames.ContainerName,
    ...
    public bool CreateContainerIfNotExists
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                BunnyBlobProviderConfigurationNames.CreateContainerIfNotExists,
                false
            );
        set =>
            _containerConfiguration.SetConfiguration(
    ...
    public string AccessKey
    {
        get =>
            _containerConfiguration.GetConfiguration<string>(
                BunnyBlobProviderConfigurationNames.AccessKey
            );
        set =>
            _containerConfiguration.SetConfiguration(
                BunnyBlobProviderConfigurationNames.AccessKey,
