...
public class LanguageTextManager : LanguageManagementDomainService, ILanguageTextManager
{
    ...
    public virtual async Task<List<LanguageTextDto>> ListAsync(
        string cultureName,
        string resourceName,
        string filter = null,
    ...
    {
        var list = await _languageTextRepository.ListAsync(
            cultureName,
            resourceName,
            filter,
            maxResultCount,
    ...
    /// 创建语言文本
    /// </summary>
    public virtual async Task<LanguageTextDto> CreateAsync(
        Guid id,
        string cultureName,
        string resourceName,
        string name,
    ...
    )
    {
        ...
        if (entity != null)
        {
            throw new LanguageManagementDomainException(
    ...
    public virtual async Task<LanguageTextDto> UpdateAsync(
        string cultureName,
        string resourceName,
        string name,
        string value
    ...
    public virtual async Task DeleteAsync(Guid id)
    {
        ...
        if (entity == null)
            throw new LanguageManagementDomainException(
                LanguageManagementErrorCodes.LanguageNotFound
            );
    ...
    /// <param name="cultureName">语言</param>
    /// <param name="resourceName">资源名称</param>
    public virtual async Task<List<LanguageTextDto>> FindAsync(
        string cultureName,
        string resourceName
    )
    {
