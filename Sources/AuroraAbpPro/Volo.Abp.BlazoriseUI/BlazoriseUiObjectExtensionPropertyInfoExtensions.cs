...
public static class BlazoriseUiObjectExtensionPropertyInfoExtensions
{
    ...
    public static string? GetDateEditInputFormatOrNull(
    ...
    public static TextInputMode GetTextInputMode(this ObjectExtensionPropertyInfo propertyInfo)
    {
        ...
        return GetTextInputModeFromTypeOrNull(propertyInfo.Type) ?? TextInputMode.None; //default
    }
    ...
    public static Type GetInputType(this ObjectExtensionPropertyInfo propertyInfo)
    {
        foreach (var attribute in propertyInfo.Attributes)
        {
            var inputTypeByAttribute = GetInputTypeFromAttributeOrNull(
                attribute,
                propertyInfo.Type
            );
        ...
        return GetInputTypeFromTypeOrNull(propertyInfo.Type) ?? typeof(TextExtensionProperty<,>); //default
    }
