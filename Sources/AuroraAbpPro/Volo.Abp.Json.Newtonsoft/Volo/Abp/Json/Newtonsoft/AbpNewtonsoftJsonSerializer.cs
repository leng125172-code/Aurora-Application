...
public class AbpNewtonsoftJsonSerializer : IJsonSerializer, ITransientDependency
{
    ...
    public T Deserialize<T>(string jsonString, bool camelCase = true)
    {
        return JsonConvert.DeserializeObject<T>(
            jsonString,
            CreateJsonSerializerOptions(camelCase)
        )!;
    }
    ...
    > JsonSerializerOptionsCache = new ConcurrentDictionary<object, JsonSerializerSettings>();

    protected virtual JsonSerializerSettings CreateJsonSerializerOptions(
        bool camelCase = true,
        bool indented = false
    )
    {
...
#pragma warning disable CS0618 // Type or member is obsolete
                var settings = new JsonSerializerSettings
                {
                    ...
                    CheckAdditionalContent = Options
                        .Value
                        .JsonSerializerSettings
                    ...
                    DateTimeZoneHandling = Options
                        .Value
                        .JsonSerializerSettings
                        .DateTimeZoneHandling,
                    DefaultValueHandling = Options
                        .Value
                        .JsonSerializerSettings
                    ...
                    MetadataPropertyHandling = Options
                        .Value
                        .JsonSerializerSettings
                        .MetadataPropertyHandling,
                    MissingMemberHandling = Options
                        .Value
                        .JsonSerializerSettings
                        .MissingMemberHandling,
                    NullValueHandling = Options.Value.JsonSerializerSettings.NullValueHandling,
                    ObjectCreationHandling = Options
                        .Value
                        .JsonSerializerSettings
