...
public static class LocalizationResourceExtensions
{
        ...
        where TLocalizationResource : LocalizationResourceBase
    {
        ...
        localizationResource.Contributors.Add(
            new JsonVirtualFileLocalizationResourceContributor(virtualPath.EnsureStartsWith('/'))
        );
        ...
        where TLocalizationResource : LocalizationResourceBase
    {
        ...
        {
            localizationResource.BaseResourceNames.AddIfNotContains(
                LocalizationResourceNameAttribute.GetName(type)
            );
        }
