...
public class AbpDictionaryBasedStringLocalizer : IAbpStringLocalizer
{
    ...
    {
        return await GetAllStringsAsync(CultureInfo.CurrentUICulture.Name, includeParentCultures);
    }
    ...
    )
    {
        ...
        //Overwrite all strings from the original culture
        await Resource.Contributors.FillAsync(cultureName, allStrings, includeDynamicContributors);
    ...
    public class CultureWrapperStringLocalizer : IAbpStringLocalizer
    {
        ...
        public CultureWrapperStringLocalizer(
            string cultureName,
            AbpDictionaryBasedStringLocalizer innerLocalizer
        )
        {
        ...
        public Task<IEnumerable<LocalizedString>> GetAllStringsAsync(
            bool includeParentCultures,
            bool includeBaseLocalizers,
            bool includeDynamicContributors
        )
