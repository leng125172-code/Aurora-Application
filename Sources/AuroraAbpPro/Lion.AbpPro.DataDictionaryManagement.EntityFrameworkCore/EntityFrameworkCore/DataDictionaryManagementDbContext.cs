namespace Lion.AbpPro.DataDictionaryManagement.EntityFrameworkCore
{
    ...
    public class DataDictionaryManagementDbContext
        : AbpDbContext<DataDictionaryManagementDbContext>,
            IDataDictionaryManagementDbContext
    {
        ...
        public DataDictionaryManagementDbContext(
            DbContextOptions<DataDictionaryManagementDbContext> options
        )
            : base(options) { }
