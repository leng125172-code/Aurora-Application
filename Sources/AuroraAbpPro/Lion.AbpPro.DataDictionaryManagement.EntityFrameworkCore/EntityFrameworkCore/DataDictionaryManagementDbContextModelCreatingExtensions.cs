namespace Lion.AbpPro.DataDictionaryManagement.EntityFrameworkCore
{
    ...
    {
        public static void ConfigureDataDictionaryManagement(this ModelBuilder builder)
        {
            ...
            {
                b.ToTable(
                    DataDictionaryManagementDbProperties.DbTablePrefix + "DataDictionaries",
                ...
                b.HasMany(e => e.Details)
                    .WithOne()
                    .HasForeignKey(uc => uc.DataDictionaryId)
            ...
            {
                b.ToTable(
                    DataDictionaryManagementDbProperties.DbTablePrefix + "DataDictionaryDetails",
                    DataDictionaryManagementDbProperties.DbSchema
                );

                // 所属字典Id - 必填
                b.Property(e => e.DataDictionaryId).IsRequired().HasComment("所属字典Id");
                ...
                // 展现列表时排序用 - 必填
                b.Property(e => e.Order).IsRequired().HasComment("展现列表时排序用");
                ...
                // 启/停用(默认启用) - 必填
                b.Property(e => e.IsEnabled).IsRequired().HasComment("启/停用(默认启用)");
