...
public class AwsBlobProviderConfiguration
{
    ...
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(
                AwsBlobProviderConfigurationNames.AccessKeyId
            );
        set =>
    ...
    public string? SecretAccessKey
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(
                AwsBlobProviderConfigurationNames.SecretAccessKey
            );
        set =>
            _containerConfiguration.SetConfiguration(
                AwsBlobProviderConfigurationNames.SecretAccessKey,
    ...
    public bool UseCredentials
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                AwsBlobProviderConfigurationNames.UseCredentials,
                false
            );
        set =>
            _containerConfiguration.SetConfiguration(
    ...
    public bool UseTemporaryCredentials
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                AwsBlobProviderConfigurationNames.UseTemporaryCredentials,
                false
            );
        set =>
            _containerConfiguration.SetConfiguration(
    ...
    public bool UseTemporaryFederatedCredentials
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                AwsBlobProviderConfigurationNames.UseTemporaryFederatedCredentials,
                false
            );
        set =>
            _containerConfiguration.SetConfiguration(
    ...
    public string? ProfilesLocation
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(
                AwsBlobProviderConfigurationNames.ProfilesLocation
            );
        set =>
            _containerConfiguration.SetConfiguration(
                AwsBlobProviderConfigurationNames.ProfilesLocation,
    ...
    public int DurationSeconds
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                AwsBlobProviderConfigurationNames.DurationSeconds,
                0
            );
        set =>
            _containerConfiguration.SetConfiguration(
    ...
    public string Name
    {
        ...
        set =>
            _containerConfiguration.SetConfiguration(AwsBlobProviderConfigurationNames.Name, value);
    }
    ...
    public string? Policy
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(
                AwsBlobProviderConfigurationNames.Policy
            );
        set =>
            _containerConfiguration.SetConfiguration(
                AwsBlobProviderConfigurationNames.Policy,
    ...
    public string? ContainerName
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(
                AwsBlobProviderConfigurationNames.ContainerName
            );
        set =>
            _containerConfiguration.SetConfiguration(
                AwsBlobProviderConfigurationNames.ContainerName,
    ...
    public bool CreateContainerIfNotExists
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                AwsBlobProviderConfigurationNames.CreateContainerIfNotExists,
                false
            );
        set =>
            _containerConfiguration.SetConfiguration(
    ...
    public string? TemporaryCredentialsCacheKey
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                AwsBlobProviderConfigurationNames.TemporaryCredentialsCacheKey,
                _temporaryCredentialsCacheKey
            );
        set =>
            _containerConfiguration.SetConfiguration(
                AwsBlobProviderConfigurationNames.TemporaryCredentialsCacheKey,
