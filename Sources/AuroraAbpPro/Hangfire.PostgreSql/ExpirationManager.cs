...
#pragma warning restore CS0618
    {
        ...
        public ExpirationManager(PostgreSqlStorage storage)
            : this(
                ...
                storage.Options.JobExpirationCheckInterval
            ) { }
        ...
        private void AggregateCounter(string counterName)
        {
          ...
          ";
                    ...
                    long aggregatedValue = connection.ExecuteScalar<long>(
                        aggregateQuery,
                        new { Key = counterName },
                        transaction
                    );
                    ...
                    if (aggregatedValue > 0)
                    {
                        ...
                        connection.Execute(
                            insertQuery,
                            new { Key = counterName, Value = aggregatedValue }
                        );
                    }
                }
            );
        ...
        private void UseConnectionDistributedLock(
            ...
            try
            {
                storage.UseConnection(
                    ...
                    connection =>
                    {
                        ...
                        {
                            PostgreSqlDistributedLock.Release(
                                connection,
                                DistributedLockKey,
                                _storage.Options
                            );
