...
namespace Hangfire.PostgreSql
{
    public static class PostgreSqlBootstrapperConfigurationExtensions
    {
        ...
        [Obsolete(
            "Will be removed in 2.0. Please use UsePostgreSqlStorage(Action<PostgreSqlBootstrapperOptions>) overload."
        )]
        ...
        {
            return configuration.UsePostgreSqlStorage(
                connectionString,
                null,
        ...
        [Obsolete(
            "Will be removed in 2.0. Please use UsePostgreSqlStorage(Action<PostgreSqlBootstrapperOptions>, PostgreSqlStorageOptions) overload."
        )]
        public static IGlobalConfiguration<PostgreSqlStorage> UsePostgreSqlStorage(
            this IGlobalConfiguration configuration,
            string connectionString,
        ...
        {
            return configuration.UsePostgreSqlStorage(
                configure => configure.UseNpgsqlConnection(connectionString, connectionSetup),
                options
            );
        }
        ...
        {
            return configuration.UsePostgreSqlStorage(
                configure => configure.UseConnectionFactory(connectionFactory),
                options
            );
        }
        ...
        public static IGlobalConfiguration<PostgreSqlStorage> UsePostgreSqlStorage(
            this IGlobalConfiguration configuration,
            Action<PostgreSqlBootstrapperOptions> configure
        )
        {
