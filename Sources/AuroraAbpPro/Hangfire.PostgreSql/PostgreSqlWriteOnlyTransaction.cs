...
namespace Hangfire.PostgreSql
{
    public class PostgreSqlWriteOnlyTransaction : JobStorageTransaction
    {
        ...
        )
        {
            ...
            _dedicatedConnectionFunc =
                dedicatedConnectionFunc
                ?? throw new ArgumentNullException(nameof(dedicatedConnectionFunc));
        }
      ...
      ";
            ...
            QueueCommand(con =>
                con.Execute(sql, new { Id = Convert.ToInt64(jobId, CultureInfo.InvariantCulture) })
            );
        }
      ...
      ";
        ...
        public override void RemoveHash(string key)
        {
            ...
            QueueCommand(con => con.Execute(sql, new { Key = key }));
        }
        ...
        public override void ExpireSet(string key, TimeSpan expireIn)
        {
            ...
            QueueCommand(connection =>
                connection.Execute(sql, new { Key = key, ExpireAt = DateTime.UtcNow.Add(expireIn) })
            );
        }
