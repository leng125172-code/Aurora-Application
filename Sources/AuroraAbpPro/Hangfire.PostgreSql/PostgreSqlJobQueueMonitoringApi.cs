    ...
    internal class PostgreSqlJobQueueMonitoringApi : IPersistentJobQueueMonitoringApi
    {
        ...
        public IEnumerable<string> GetQueues()
        {
            ...
            return _storage.UseConnection(
                null,
                connection => connection.Query<string>(sqlQuery).AsList()
            );
        }
      ...
      ";
            ...
            (long enqueuedCount, long fetchedCount) = _storage
                .UseConnection(
                    null,
                    connection =>
                        connection.Query<EnqueuedAndFetchedCount>(sqlQuery, new { Queue = queue })
                )
                .Single();
        ...
        private IEnumerable<long> GetQueuedOrFetchedJobIds(
            string queue,
            bool fetched,
            int from,
            int perPage
