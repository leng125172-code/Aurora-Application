...
public static class IdentityDbContextModelBuilderExtensions
{
    public static void ConfigureIdentity([NotNull] this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "Users",
            ...
            b.HasMany(u => u.OrganizationUnits)
                .WithOne()
                .HasForeignKey(ur => ur.UserId)
                .IsRequired();
            b.HasMany(u => u.PasswordHistories)
                .WithOne()
                .HasForeignKey(ur => ur.UserId)
                .IsRequired();
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "UserClaims",
                AbpIdentityDbProperties.DbSchema
            );
            ...
            b.Property(uc => uc.ClaimType)
                .HasMaxLength(IdentityUserClaimConsts.MaxClaimTypeLength)
                .IsRequired();
            b.Property(uc => uc.ClaimValue)
                .HasMaxLength(IdentityUserClaimConsts.MaxClaimValueLength);
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "UserRoles",
                AbpIdentityDbProperties.DbSchema
            );
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "UserLogins",
                AbpIdentityDbProperties.DbSchema
            );
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "UserTokens",
                AbpIdentityDbProperties.DbSchema
            );
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "Roles",
                AbpIdentityDbProperties.DbSchema
            );
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "RoleClaims",
                AbpIdentityDbProperties.DbSchema
            );
            ...
            b.Property(uc => uc.ClaimType)
                .HasMaxLength(IdentityRoleClaimConsts.MaxClaimTypeLength)
                .IsRequired();
            b.Property(uc => uc.ClaimValue)
                .HasMaxLength(IdentityRoleClaimConsts.MaxClaimValueLength);
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(
                    AbpIdentityDbProperties.DbTablePrefix + "ClaimTypes",
                    AbpIdentityDbProperties.DbSchema
                );

                b.ConfigureByConvention();

                b.Property(uc => uc.Name)
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "UserPasskeys",
                AbpIdentityDbProperties.DbSchema
            );
            ...
            b.Property(p => p.CredentialId)
                .HasMaxLength(IdentityUserPasskeyConsts.MaxCredentialIdLength); // Defined in WebAuthn spec to be no longer than 1023 bytes
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "OrganizationUnits",
                AbpIdentityDbProperties.DbSchema
            );

            b.ConfigureByConvention();

            b.Property(ou => ou.Code)
                .IsRequired()
                .HasMaxLength(OrganizationUnitConsts.MaxCodeLength)
                .HasColumnName(nameof(OrganizationUnit.Code));
            b.Property(ou => ou.DisplayName)
                .IsRequired()
                .HasMaxLength(OrganizationUnitConsts.MaxDisplayNameLength)
                .HasColumnName(nameof(OrganizationUnit.DisplayName));

            b.HasMany<OrganizationUnit>().WithOne().HasForeignKey(ou => ou.ParentId);
            b.HasMany(ou => ou.Roles)
                .WithOne()
                .HasForeignKey(our => our.OrganizationUnitId)
                .IsRequired();
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "OrganizationUnitRoles",
                AbpIdentityDbProperties.DbSchema
            );
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "UserOrganizationUnits",
                AbpIdentityDbProperties.DbSchema
            );
            ...
            b.HasOne<OrganizationUnit>()
                .WithMany()
                .HasForeignKey(ou => ou.OrganizationUnitId)
                .IsRequired();
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "UserPasswordHistories",
                AbpIdentityDbProperties.DbSchema
            );
            ...
            b.Property(x => x.Password)
                .HasMaxLength(IdentityUserPasswordHistoriesConsts.MaxPasswordLength)
                .IsRequired();
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "SecurityLogs",
                AbpIdentityDbProperties.DbSchema
            );
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(
                    AbpIdentityDbProperties.DbTablePrefix + "LinkUsers",
                    AbpIdentityDbProperties.DbSchema
                );
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "UserDelegations",
                AbpIdentityDbProperties.DbSchema
            );
        ...
        {
            b.ToTable(
                AbpIdentityDbProperties.DbTablePrefix + "Sessions",
                AbpIdentityDbProperties.DbSchema
            );
            ...
            b.Property(x => x.SessionId)
                .HasMaxLength(IdentitySessionConsts.MaxSessionIdLength)
                .IsRequired();
            b.Property(x => x.Device)
                .HasMaxLength(IdentitySessionConsts.MaxDeviceLength)
                .IsRequired();
