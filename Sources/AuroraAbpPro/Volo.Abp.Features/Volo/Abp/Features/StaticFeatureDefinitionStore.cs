...
public class StaticFeatureDefinitionStore : IStaticFeatureDefinitionStore, ISingletonDependency
{
    ...
    protected IStaticDefinitionCache<
        ...
        Dictionary<string, FeatureGroupDefinition>
    > GroupCache { get; }
    protected IStaticDefinitionCache<
        FeatureDefinition,
        Dictionary<string, FeatureDefinition>
    > DefinitionCache { get; }
    ...
    protected virtual async Task<
        Dictionary<string, FeatureGroupDefinition>
    > GetFeatureGroupDefinitionsAsync()
    {
    ...
    protected virtual Task<
        Dictionary<string, FeatureGroupDefinition>
    > CreateFeatureGroupDefinitionsAsync()
    {
