...
public class FeatureGroupDefinition : ICanCreateChildFeature
{
    ...
    protected internal FeatureGroupDefinition(string name, ILocalizableString? displayName = null)
    {
        Name = name;
    ...
    public FeatureDefinition CreateChildFeature(
        string name,
        string? defaultValue = null,
        ILocalizableString? displayName = null,
        ILocalizableString? description = null,
    ...
    private void AddFeatureToListRecursively(
