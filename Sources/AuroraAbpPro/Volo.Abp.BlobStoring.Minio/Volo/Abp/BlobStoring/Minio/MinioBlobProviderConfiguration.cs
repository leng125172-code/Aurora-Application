...
public class MinioBlobProviderConfiguration
{
    public string? BucketName
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(
                MinioBlobProviderConfigurationNames.BucketName
            );
        set =>
    ...
    public string EndPoint
    {
        get =>
            _containerConfiguration.GetConfiguration<string>(
                MinioBlobProviderConfigurationNames.EndPoint
            );
        set =>
            _containerConfiguration.SetConfiguration(
                MinioBlobProviderConfigurationNames.EndPoint,
    ...
    public string AccessKey
    {
        get =>
            _containerConfiguration.GetConfiguration<string>(
                MinioBlobProviderConfigurationNames.AccessKey
            );
        set =>
            _containerConfiguration.SetConfiguration(
                MinioBlobProviderConfigurationNames.AccessKey,
    ...
    public string SecretKey
    {
        get =>
            _containerConfiguration.GetConfiguration<string>(
                MinioBlobProviderConfigurationNames.SecretKey
            );
        set =>
            _containerConfiguration.SetConfiguration(
                MinioBlobProviderConfigurationNames.SecretKey,
    ...
    public bool WithSSL
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                MinioBlobProviderConfigurationNames.WithSSL,
                false
            );
        set =>
            _containerConfiguration.SetConfiguration(
    ...
    public bool CreateBucketIfNotExists
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                MinioBlobProviderConfigurationNames.CreateBucketIfNotExists,
                false
            );
        set =>
            _containerConfiguration.SetConfiguration(
    ...
    public int PresignedGetExpirySeconds
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault(
                MinioBlobProviderConfigurationNames.PresignedGetExpirySeconds,
