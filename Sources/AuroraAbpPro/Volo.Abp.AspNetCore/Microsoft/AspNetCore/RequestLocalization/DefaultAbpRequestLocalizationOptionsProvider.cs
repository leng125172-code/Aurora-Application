        ...
        ISingletonDependency
{
    ...
    public virtual void InitLocalizationOptions(
                ...
                if (_requestLocalizationOptions == null)
                {
                    using (var serviceScope = _serviceProviderFactory.CreateScope())
                    {
                        var languageProvider =
                            serviceScope.ServiceProvider.GetRequiredService<ILanguageProvider>();
                        var settingProvider =
                            serviceScope.ServiceProvider.GetRequiredService<ISettingProvider>();
                        ...
                        var options = !languages.Any()
                            ...
                            : new RequestLocalizationOptions
                            {
                                DefaultRequestCulture = GetDefaultRequestCulture(
                                    defaultLanguage,
                                    languages
                                ),
                        ...
                        foreach (
                            var configurator in serviceScope
                                .ServiceProvider.GetRequiredService<
                                    IOptions<AbpRequestLocalizationOptions>
                                >()
    ...
    private static RequestCulture GetDefaultRequestCulture(
    ...
    )
    {
        ...
        var (cultureName, uiCultureName) = LocalizationSettingHelper.ParseLanguageSetting(
            defaultLanguage
        );
