...
public static class AbpApplicationBuilderExtensions
{
    ...
    public static async Task InitializeApplicationAsync([NotNull] this IApplicationBuilder app)
    {
        ...
        {
            app.ApplicationServices.GetRequiredService<ObjectAccessor<WebApplication>>().Value =
                webApplication;
        }
        ...
        {
            app
                .ApplicationServices.GetRequiredService<ObjectAccessor<IEndpointRouteBuilder>>()
                .Value = endpointRouteBuilder;
        }
        var application =
            app.ApplicationServices.GetRequiredService<IAbpApplicationWithExternalServiceProvider>();
    ...
    {
        return app.UseMiddleware<AbpAuditingMiddleware>();
    }

    public static IApplicationBuilder UseUnitOfWork(this IApplicationBuilder app)
    {
        return app.UseAbpExceptionHandling().UseMiddleware<AbpUnitOfWorkMiddleware>();
    }
    ...
    {
        app.ApplicationServices.GetRequiredService<IAbpRequestLocalizationOptionsProvider>()
    ...
    public static IApplicationBuilder UseStaticFilesForPatterns(
        this IApplicationBuilder app,
        params string[] includeFileNamePatterns
    )
    {
        return UseStaticFilesForPatterns(
            app,
            includeFileNamePatterns,
            app.ApplicationServices.GetRequiredService<IWebHostEnvironment>().WebRootFileProvider
        );
    }
    ...
    public static IApplicationBuilder UseStaticFilesForPatterns(
        this IApplicationBuilder app,
        string[] includeFileNamePatterns,
    ...
    /// </summary>
    public static StaticAssetsEndpointConventionBuilder MapAbpStaticAssets(
    ...
    )
    {
        ...
        var options = app
            .ApplicationServices.GetRequiredService<IOptions<AbpAspNetCoreContentOptions>>()
            .Value;
    ...
    public static IApplicationBuilder UseVirtualStaticFiles(this IApplicationBuilder app)
    {
        app.UseStaticFiles(
            ...
            {
                ContentTypeProvider =
                    app.ApplicationServices.GetRequiredService<AbpFileExtensionContentTypeProvider>(),
                FileProvider = new WebContentFileProvider(
                    ...
                    app.ApplicationServices.GetRequiredService<
                        IOptions<AbpAspNetCoreContentOptions>
                    >()
                ),
            }
        );
    ...
    /// </summary>
    public static IApplicationBuilder UseVirtualStaticFiles(
        this IApplicationBuilder app,
        string folder
    )
    {
        ...
        var root = Path.Combine(
            app.ApplicationServices.GetRequiredService<IWebHostEnvironment>().ContentRootPath,
            folder
        );
