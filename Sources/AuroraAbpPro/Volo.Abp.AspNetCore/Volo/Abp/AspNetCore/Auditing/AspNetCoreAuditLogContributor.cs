...
public class AspNetCoreAuditLogContributor : AuditLogContributor, ITransientDependency
{
    ...
    public override void PreContribute(AuditLogContributionContext context)
    {
        ...
        var clientInfoProvider =
            context.ServiceProvider.GetRequiredService<IWebClientInfoProvider>();
    ...
    public override void PostContribute(AuditLogContributionContext context)
    {
        ...
        {
            var httpExceptionStatusCodeFinder =
                context.ServiceProvider.GetRequiredService<IHttpExceptionStatusCodeFinder>();
            foreach (var auditInfoException in context.AuditInfo.Exceptions)
            {
                var statusCode = httpExceptionStatusCodeFinder.GetStatusCode(
                    httpContext,
                    auditInfoException
                );
    ...
    protected virtual string GetUrl(AuditLogContributionContext context, HttpContext httpContext)
    {
        var options = context.ServiceProvider.GetRequiredService<
            IOptions<AbpAspNetCoreAuditingUrlOptions>
        >();
