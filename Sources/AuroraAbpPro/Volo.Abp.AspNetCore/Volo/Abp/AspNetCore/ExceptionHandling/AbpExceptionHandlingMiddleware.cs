...
public class AbpExceptionHandlingMiddleware : AbpMiddlewareBase, ITransientDependency
{
    ...
    {
        var exceptionHandlingOptions = httpContext
            .RequestServices.GetRequiredService<IOptions<AbpExceptionHandlingOptions>>()
            .Value;
