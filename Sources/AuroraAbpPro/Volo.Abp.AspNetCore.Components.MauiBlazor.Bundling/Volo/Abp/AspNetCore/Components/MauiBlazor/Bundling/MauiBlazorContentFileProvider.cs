...
public class MauiBlazorContentFileProvider : IMauiBlazorContentFileProvider, ISingletonDependency
{
    ...
    public IFileInfo GetFileInfo(string subpath)
    {
        ...
        return fileInfo.Exists
            ? fileInfo
            : _fileProvider.GetFileInfo(_rootPath + subpath.EnsureStartsWith('/'));
    }
    ...
    public IDirectoryContents GetDirectoryContents(string subpath)
    {
        ...
        return directory.Exists
            ? directory
            : _fileProvider.GetDirectoryContents(_rootPath + subpath.EnsureStartsWith('/'));
    }
    ...
    protected virtual IFileProvider CreateFileProvider()
    {
        ...
        return new CompositeFileProvider(
            new PhysicalFileProvider(assetsDirectory),
