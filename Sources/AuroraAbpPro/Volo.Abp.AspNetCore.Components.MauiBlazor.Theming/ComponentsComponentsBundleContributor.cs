...
[Obsolete(
    "This class is obsolete and will be removed in the future versions. Use GlobalAssets instead."
)]
public class ComponentsComponentsBundleContributor : IBundleContributor
{
    ...
    public void AddStyles(BundleContext context)
    {
        ...
        {
            context.BundleDefinitions.Insert(
                0,
                new BundleDefinition
                {
                    Source =
                        "_content/Volo.Abp.AspNetCore.Components.MauiBlazor.Theming/libs/bootstrap/css/bootstrap.min.css",
                }
            );
            context.BundleDefinitions.Insert(
                1,
                ...
                {
                    Source =
                        "_content/Volo.Abp.AspNetCore.Components.MauiBlazor.Theming/libs/fontawesome/css/all.css",
                }
            );
        }
        context.Add("_content/Volo.Abp.AspNetCore.Components.Web/libs/abp/css/abp.css");
        context.Add(
            "_content/Volo.Abp.AspNetCore.Components.MauiBlazor.Theming/libs/flag-icon/css/flag-icon.css"
        );
