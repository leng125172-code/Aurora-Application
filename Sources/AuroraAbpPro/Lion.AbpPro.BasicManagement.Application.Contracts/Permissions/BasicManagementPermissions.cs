...
public class BasicManagementPermissions
{
    ...
    public static class SystemManagement
    {
        ...
        public const string ResetUserTwoFactor = Default + ".Users.ResetTwoFactor";
        ...
        public const string OnlineManagement = Default + ".OnlineManagement";
        public const string OnlineManagementForceOut = OnlineManagement + ".ForceOut";
