    ...
    protected override void OnEventCommand(EventCommandEventArgs args)
    {
        if (args.Command == EventCommand.Enable)
        {
            _publishPerSecondCounter ??= new IncrementingEventCounter(
                CapDiagnosticListenerNames.PublishedPerSec,
                this
            )
            {
            ...
            _consumePerSecondCounter ??= new IncrementingEventCounter(
                CapDiagnosticListenerNames.ConsumePerSec,
                this
            )
            {
            ...
            _subscriberInvokePerSecondCounter ??= new IncrementingEventCounter(
                CapDiagnosticListenerNames.InvokeSubscriberPerSec,
                this
            )
            {
            ...
            _invokeCounter ??= new EventCounter(
                CapDiagnosticListenerNames.InvokeSubscriberElapsedMs,
                this
            )
            {
