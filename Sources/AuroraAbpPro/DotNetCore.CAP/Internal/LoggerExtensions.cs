...
{
    public static void ConsumerExecutedAfterThreshold(
        this ILogger logger,
        string messageId,
        int retries
    )
    ...
    public static void MessagePublishException(
        this ILogger logger,
        string? messageId,
        string reason,
        Exception? ex
    ...
    public static void ConsumerExecuting(
        this ILogger logger,
        string className,
        string methodName,
        string group
    ...
    public static void ConsumerExecuteFailed(
        this ILogger logger,
        string topic,
        string id,
        string? instance,
