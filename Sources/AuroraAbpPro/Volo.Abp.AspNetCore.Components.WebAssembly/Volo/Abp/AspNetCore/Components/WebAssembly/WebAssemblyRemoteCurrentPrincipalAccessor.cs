        ...
        ITransientDependency
{
    ...
    protected override ClaimsPrincipal GetClaimsPrincipal()
    {
        ...
        if (
            ...
            || !applicationConfiguration.CurrentUser.IsAuthenticated
        )
        {
        ...
        if (applicationConfiguration.CurrentUser.TenantId != null)
        {
            claims.Add(
                new Claim(
                    ...
                    applicationConfiguration.CurrentUser.TenantId.ToString()!
                )
            );
        }
        if (applicationConfiguration.CurrentUser.ImpersonatorUserId != null)
        {
            claims.Add(
                new Claim(
                    ...
                    applicationConfiguration.CurrentUser.ImpersonatorUserId.ToString()!
                )
            );
        }
        if (applicationConfiguration.CurrentUser.ImpersonatorTenantId != null)
        {
            claims.Add(
                new Claim(
                    ...
                    applicationConfiguration.CurrentUser.ImpersonatorTenantId.ToString()!
                )
            );
        }
        if (applicationConfiguration.CurrentUser.ImpersonatorUserName != null)
        {
            claims.Add(
                new Claim(
                    ...
                    applicationConfiguration.CurrentUser.ImpersonatorUserName
                )
            );
        }
        if (applicationConfiguration.CurrentUser.ImpersonatorTenantName != null)
        {
            claims.Add(
                new Claim(
                    ...
                    applicationConfiguration.CurrentUser.ImpersonatorTenantName
                )
            );
        }
        ...
        {
            claims.Add(
                new Claim(AbpClaimTypes.UserName, applicationConfiguration.CurrentUser.UserName)
            );
        }
        ...
        {
            claims.Add(
                new Claim(AbpClaimTypes.SurName, applicationConfiguration.CurrentUser.SurName)
            );
        }
        ...
        if (applicationConfiguration.CurrentUser.EmailVerified)
        {
            claims.Add(
                new Claim(
                    ...
                    applicationConfiguration.CurrentUser.EmailVerified.ToString()
                )
            );
        }
        if (applicationConfiguration.CurrentUser.PhoneNumber != null)
        {
            claims.Add(
                new Claim(
                    ...
                    applicationConfiguration.CurrentUser.PhoneNumber
                )
            );
        }
        if (applicationConfiguration.CurrentUser.PhoneNumberVerified)
        {
            claims.Add(
                new Claim(
                    ...
                    applicationConfiguration.CurrentUser.PhoneNumberVerified.ToString()
                )
            );
        }
        ...
        {
            claims.Add(
                new Claim(AbpClaimTypes.SessionId, applicationConfiguration.CurrentUser.SessionId)
            );
        }
        ...
        return new ClaimsPrincipal(
            new ClaimsIdentity(
                claims,
                authenticationType: nameof(WebAssemblyRemoteCurrentPrincipalAccessor)
            )
        );
    }
}
