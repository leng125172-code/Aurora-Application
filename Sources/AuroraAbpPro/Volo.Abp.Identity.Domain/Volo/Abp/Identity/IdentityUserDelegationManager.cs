...
public class IdentityUserDelegationManager : DomainService
{
    ...
    public IdentityUserDelegationManager(
    ...
    {
        return await IdentityUserDelegationRepository.GetListAsync(
            sourceUserId,
            targetUserId,
    ...
    {
        return await IdentityUserDelegationRepository.GetActiveDelegationsAsync(
            targetUseId,
            cancellationToken: cancellationToken
        );
    }
    ...
    {
        return await IdentityUserDelegationRepository.FindActiveDelegationByIdAsync(
            id,
            cancellationToken: cancellationToken
        );
    }
    ...
    public virtual async Task DeleteDelegationAsync(
        Guid id,
        Guid sourceUserId,
        CancellationToken cancellationToken = default
    )
    {
        var delegation = await IdentityUserDelegationRepository.FindAsync(
            id,
            cancellationToken: cancellationToken
        );
        ...
        {
            await IdentityUserDelegationRepository.DeleteAsync(
                delegation,
                cancellationToken: cancellationToken
            );
        }
