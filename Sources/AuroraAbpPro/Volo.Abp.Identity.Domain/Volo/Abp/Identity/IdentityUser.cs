...
public class IdentityUser : FullAuditedAggregateRoot<Guid>, IUser, IHasEntityVersion
{
    ...
    /// </summary>
    public virtual ICollection<IdentityUserOrganizationUnit> OrganizationUnits
    {
        get;
        protected set;
    }
    ...
    /// </summary>
    public virtual ICollection<IdentityUserPasswordHistory> PasswordHistories
    {
        get;
        protected set;
    }
    ...
    public virtual void ReplaceClaim([NotNull] Claim claim, [NotNull] Claim newClaim)
    {
        ...
        var userClaims = Claims.Where(uc =>
    ...
    public virtual void AddOrganizationUnit(Guid organizationUnitId)
    {
        ...
        OrganizationUnits.Add(new IdentityUserOrganizationUnit(Id, organizationUnitId, TenantId));
    }
    ...
    {
        PasswordHistories.Add(new IdentityUserPasswordHistory(Id, password, TenantId));
    }
    ...
    public virtual IdentityUserPasskey FindPasskey(byte[] credentialId)
    {
        return Passkeys.FirstOrDefault(x =>
            x.UserId == Id && x.CredentialId.SequenceEqual(credentialId)
        );
    }
