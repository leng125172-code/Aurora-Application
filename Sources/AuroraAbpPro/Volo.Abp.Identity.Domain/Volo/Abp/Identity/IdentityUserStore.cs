        ...
        ITransientDependency
{
    ...
    /// </returns>
    public virtual Task<IdentityUser> FindByIdAsync(
        string userId,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </returns>
    public virtual Task<IdentityUser> FindByNameAsync(
    ...
    )
    {
        ...
        return UserRepository.FindByNormalizedUserNameAsync(
            normalizedUserName,
    ...
    )
    {
        ...
        var userRoles = await UserRepository.GetRoleNamesAsync(
            user.Id,
            cancellationToken: cancellationToken
        );

        var userOrganizationUnitRoles = await UserRepository.GetRoleNamesInOrganizationUnitAsync(
            user.Id,
            cancellationToken: cancellationToken
        );
    ...
    /// </returns>
    public virtual Task<IdentityUser> FindByLoginAsync(
        [NotNull] string loginProvider,
        [NotNull] string providerKey,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return UserRepository.FindByLoginAsync(
            loginProvider,
            providerKey,
            cancellationToken: cancellationToken
        );
    ...
    /// </returns>
    public virtual Task<IdentityUser> FindByEmailAsync(
        string normalizedEmail,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return UserRepository.FindByNormalizedEmailAsync(
            normalizedEmail,
            includeDetails: false,
            cancellationToken: cancellationToken
        );
    ...
    /// </returns>
    public virtual async Task<IList<IdentityUser>> GetUsersForClaimAsync(
        [NotNull] Claim claim,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return await UserRepository.GetListByClaimAsync(
            claim,
            cancellationToken: cancellationToken
        );
    }
    ...
    /// </returns>
    public virtual async Task<IList<IdentityUser>> GetUsersInRoleAsync(
        [NotNull] string normalizedRoleName,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return await UserRepository.GetListByNormalizedRoleNameAsync(
            normalizedRoleName,
            cancellationToken: cancellationToken
        );
    }
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
    public virtual async Task AddOrUpdatePasskeyAsync(
        IdentityUser user,
    ...
    public virtual async Task<IList<UserPasskeyInfo>> GetPasskeysAsync(
        IdentityUser user,
        CancellationToken cancellationToken
    )
    {
    ...
    {
        cancellationToken.ThrowIfCancellationRequested();
        return await UserRepository.FindByPasskeyIdAsync(
            credentialId,
            cancellationToken: cancellationToken
        );
    }
    ...
    public virtual async Task<UserPasskeyInfo> FindPasskeyAsync(
        IdentityUser user,
        byte[] credentialId,
        CancellationToken cancellationToken
    )
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
    public virtual async Task RemovePasskeyAsync(
        IdentityUser user,
        byte[] credentialId,
        CancellationToken cancellationToken
    )
