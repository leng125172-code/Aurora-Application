...
public class AbpBorderTagHelperService : AbpTagHelperService<AbpBorderTagHelper>
{
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        var borderClass =
            "border"
            + GetBorderDirection(context, output, borderAttributeAsString)
            + GetExtensionIfBorderIsSubtractive(context, output, borderAttributeAsString);
    ...
    protected virtual string GetBorderDirection(
        TagHelperContext context,
        TagHelperOutput output,
        string borderAttributeAsString
    )
    {
    ...
    protected virtual string GetExtensionIfBorderIsSubtractive(
        TagHelperContext context,
        TagHelperOutput output,
        string borderAttributeAsString
    )
    ...
    protected virtual void SetBorderType(
        TagHelperContext context,
        TagHelperOutput output,
        string borderAttributeAsString
    )
