...
public class AbpAccordionItemTagHelperService : AbpTagHelperService<AbpAccordionItemTagHelper>
{
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        var html =
            GetAccordionHeaderItem(context, output)
            + GetAccordionContentItem(context, output, childContent);
    ...
    protected virtual string GetAccordionHeaderItem(
    ...
    protected virtual string GetAccordionContentItem(
        TagHelperContext context,
        TagHelperOutput output,
