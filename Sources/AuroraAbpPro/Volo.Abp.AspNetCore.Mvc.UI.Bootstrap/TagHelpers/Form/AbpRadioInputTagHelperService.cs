...
public class AbpRadioInputTagHelperService : AbpTagHelperService<AbpRadioInputTagHelper>
{
    ...
    protected virtual async Task<string> GetRadioInputGroupAsHtmlAsync(
    ...
    protected virtual string GetInfoAsHtml(TagHelperContext context, TagHelperOutput output)
    {
        ...
        {
            text = _tagHelperLocalizer.GetLocalizedText(
                infoAttribute.Text,
    ...
    )
    {
        ...
        {
            return GetSelectItemsFromAttribute(
    ...
    protected virtual string GetLocalizedPropertyName(
    ...
    protected virtual void SetSelectedValue(
        TagHelperContext context,
        TagHelperOutput output,
        List<SelectListItem> selectItems
    )
