...
public class AbpDatePickerTagHelperService
    : AbpDatePickerBaseTagHelperService<AbpDatePickerTagHelper>
{
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        if (TagHelper.AspFor != null)
        {
            ...
            DateTagHelperOutput = await DateTagHelper.ProcessAndGetOutputAsync(
                attributes,
                context,
                "input"
            );
    ...
    protected override void AddBaseTagAttributes(TagHelperAttributeList attributes)
    {
        if (
            ...
            && SupportedInputTypes.TryGetValue(
                TagHelper.AspFor.Metadata.ModelType,
                out var convertFunc
            )
        )
        {
