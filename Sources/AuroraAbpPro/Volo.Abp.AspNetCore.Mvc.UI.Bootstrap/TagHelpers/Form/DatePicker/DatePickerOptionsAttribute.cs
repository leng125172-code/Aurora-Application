...
public class DatePickerOptionsAttribute : Attribute
{
    ...
    {
        var properties = explorer
            .Container.Properties.Where(p =>
                p.Metadata.PropertyName != null
                && p.Metadata.PropertyName.Equals(DatePickerOptionsPropertyName)
            )
            .ToList();
        ...
        return properties.FirstOrDefault(p => p.Model is IAbpDatePickerOptions)?.Model
            as IAbpDatePickerOptions;
    }
}
