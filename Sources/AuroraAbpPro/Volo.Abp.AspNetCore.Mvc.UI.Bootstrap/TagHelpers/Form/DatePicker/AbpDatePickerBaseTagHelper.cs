...
public abstract class AbpDatePickerBaseTagHelper<TTagHelper>
    : AbpTagHelper<TTagHelper, AbpDatePickerBaseTagHelperService<TTagHelper>>,
    ...
    where TTagHelper : AbpDatePickerBaseTagHelper<TTagHelper>
{
    ...
    protected AbpDatePickerBaseTagHelper(
        AbpDatePickerBaseTagHelperService<TTagHelper> service,
