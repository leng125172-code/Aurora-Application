...
public class AbpCarouselTagHelperService : AbpTagHelperService<AbpCarouselTagHelper>
{
    ...
    protected virtual List<CarouselItem> InitilizeCarouselItemsContentsContext(
    ...
    protected virtual void SetIndicators(
        TagHelperContext context,
        TagHelperOutput output,
        List<CarouselItem> itemList
    )
    ...
    protected virtual void SetOneItemAsActive(
        TagHelperContext context,
        TagHelperOutput output,
        List<CarouselItem> itemList
    )
