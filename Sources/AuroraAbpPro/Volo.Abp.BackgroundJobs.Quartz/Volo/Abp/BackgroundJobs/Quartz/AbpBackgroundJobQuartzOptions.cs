...
public class AbpBackgroundJobQuartzOptions
{
    ...
    )
    {
        ...
        var retryCount = executionContext
            .JobDetail.JobDataMap.GetString(
                QuartzBackgroundJobManager.JobDataPrefix + nameof(RetryCount)
            )!
            .To<int>();
        ...
        var retryInterval = executionContext
            .JobDetail.JobDataMap.GetString(
                QuartzBackgroundJobManager.JobDataPrefix + nameof(RetryIntervalMillisecond)
            )!
            .To<int>();
