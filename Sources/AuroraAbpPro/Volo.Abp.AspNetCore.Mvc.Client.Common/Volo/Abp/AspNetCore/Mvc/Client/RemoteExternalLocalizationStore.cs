...
public class RemoteExternalLocalizationStore : IExternalLocalizationStore, ITransientDependency
{
    ...
    public virtual async Task<string[]> GetResourceNamesAsync()
    {
        ...
        return configurationDto
            .Localization.Resources.Keys.Where(x => !LocalizationOptions.Resources.ContainsKey(x))
            .ToArray();
        ;
    }
    ...
    {
        return new NonTypedLocalizationResource(resourceName).AddBaseResources(
            resourceDto.BaseResources
        );
    }
}
