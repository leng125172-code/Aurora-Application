...
public class RemoteDynamicClaimsPrincipalContributorCache
    : RemoteDynamicClaimsPrincipalContributorCacheBase<RemoteDynamicClaimsPrincipalContributorCache>
{
    ...
    protected override async Task<AbpDynamicClaimCacheItem?> GetCacheAsync(
        Guid userId,
        Guid? tenantId = null
    )
    {
    ...
    protected override async Task RefreshAsync(Guid userId, Guid? tenantId = null)
    {
        try
        {
            ...
            var requestMessage = new HttpRequestMessage(
                HttpMethod.Post,
                AbpClaimsPrincipalFactoryOptions.Value.RemoteRefreshUrl
            );
        ...
        catch (Exception e)
        {
            ...
            await ApplicationConfigurationDtoCache.RemoveAsync(
                await CacheHelper.CreateCacheKeyAsync(CurrentUser.Id)
            );
            throw;
        }
    }
