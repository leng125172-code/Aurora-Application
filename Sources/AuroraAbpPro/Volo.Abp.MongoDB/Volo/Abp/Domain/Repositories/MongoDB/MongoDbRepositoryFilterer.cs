    ...
    where TEntity : class, IEntity
{
    ...
    public virtual TQueryable FilterQueryable<TQueryable>(TQueryable query)
    ...
    where TEntity : class, IEntity<TKey>
{
    ...
    public virtual async Task<FilterDefinition<TEntity>> CreateEntityFilterAsync(
        TKey id,
    ...
    public virtual Task<FilterDefinition<TEntity>> CreateEntityFilterAsync(
        TEntity entity,
    ...
    )
    {
        ...
        return Task.FromResult<FilterDefinition<TEntity>>(
    ...
    public virtual async Task<FilterDefinition<TEntity>> CreateEntitiesFilterAsync(
