...
namespace StackExchange.Profiling
{
    public partial class MiniProfiler
    {
        ...
        public static T Configure<T>(T options)
        ...
        /// </param>
        public static MiniProfiler? StartNew(string? profilerName = null) =>
            DefaultOptions.StartProfiler(profilerName);
    }
}
