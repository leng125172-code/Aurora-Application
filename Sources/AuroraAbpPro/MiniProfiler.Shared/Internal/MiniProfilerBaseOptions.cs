...
namespace StackExchange.Profiling.Internal
{
    ...
    public class MiniProfilerBaseOptions
    {
        ...
        /// </summary>
        public HashSet<string> ExcludedMethods { get; } =
            new HashSet<string> { "lambda_method", ".ctor" };
        ...
        public HashSet<string> IgnoredPaths { get; } =
            new HashSet<string> { "/content/", "/scripts/", "/favicon.ico" };
        ...
        /// </summary>
        public HashSet<string> IgnoredDuplicateExecuteTypes { get; } =
            new HashSet<string>()
            {
        ...
        public MiniProfiler? StartProfiler(string? profilerName = null) =>
            ProfilerProvider.Start(profilerName, this);
