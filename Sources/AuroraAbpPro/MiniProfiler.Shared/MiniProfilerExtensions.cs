...
namespace StackExchange.Profiling
{
    ...
    public static class MiniProfilerExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NotNullIfNotNull(nameof(profiler))]
        public static CustomTiming? CustomTiming(
            this MiniProfiler? profiler,
            string category,
        ...
        /// </remarks>
        [return: NotNullIfNotNull(nameof(profiler))]
        public static CustomTiming? CustomTimingIf(
            this MiniProfiler? profiler,
            string category,
            string commandString,
            decimal minSaveMs,
        ...
        {
            if (profiler == null || profiler.Head == null || !profiler.IsActive)
                return null;

            var result = new CustomTiming(
                profiler,
                commandString,
                minSaveMs,
                includeStackTrace: includeStackTrace
        ...
        public static IDisposable? Ignore(this MiniProfiler? profiler) =>
            profiler != null ? new Suppression(profiler) : null;
        ...
        public static void AddProfilerResults(
            this MiniProfiler? profiler,
            MiniProfiler externalProfiler
        )
        {
                ...
                if (timing.HasCustomTimings)
                {
                    foreach (var pair in timing.CustomTimings)
                    {
                        ...
                        text.Append(" (")
                            ...
                            .Append(" = ")
                            .Append(
                                (customTimings.Sum(ct => ct.DurationMilliseconds) ?? 0).ToString(
                                    "###,##0.##"
                                )
                            )
                            .Append("ms in ")
