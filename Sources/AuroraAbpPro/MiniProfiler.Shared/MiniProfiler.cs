...
#pragma warning restore CS8618
        ...
        public async Task<bool> StopAsync(bool discardResults = false)
        {
            ...
            {
                await Options
                    .ProfilerProvider.StoppedAsync(this, discardResults)
        ...
        public override string ToString() =>
            Root != null ? Root.Name + " (" + DurationMilliseconds + " ms)" : string.Empty;
        ...
        public override bool Equals(object? obj) =>
            obj is MiniProfiler miniProfiler && Id.Equals(miniProfiler.Id);
        ...
        internal Timing StepImpl(
            string? name,
            decimal? minSaveMs = null,
