...
namespace StackExchange.Profiling
{
    ...
    public static class MiniProfilerOptionsExtensions
    {
        ...
        public static T ExcludeAssembly<T>(this T options, string assembly)
            where T : MiniProfilerBaseOptions
        {
        ...
        public static T ExcludeMethod<T>(this T options, string method)
            where T : MiniProfilerBaseOptions
        {
        ...
        public static T ExcludeType<T>(this T options, string type)
            where T : MiniProfilerBaseOptions
        {
        ...
        public static T IgnorePath<T>(this T options, string path)
            where T : MiniProfilerBaseOptions
        {
