...
namespace StackExchange.Profiling.Data
{
    ...
    public class ProfiledDbDataAdapter : DbDataAdapter
    {
        ...
        {
            InternalAdapter =
                wrappedAdapter ?? throw new ArgumentNullException(nameof(wrappedAdapter));
        ...
        public new DataTable[] FillSchema(DataSet dataSet, SchemaType schemaType) =>
            InternalAdapter.FillSchema(dataSet, schemaType);
        ...
        {
            var dbDataAdapter =
                InternalAdapter as DbDataAdapter
                ?? throw new InvalidOperationException(
                    "This function is only supported when profiling a DbDataAdapter object. If you are using an adapter which implements IDbDataAdapter but does not inherit from DbDataAdapter then you cannot use this function."
                );
        ...
        public new IDbCommand? SelectCommand
        {
            ...
            set
            {
                ...
                InternalAdapter.SelectCommand = value is ProfiledDbCommand cmd
                    ? cmd.WrappedCommand
                    : value;
            }
        }
        ...
        public new IDbCommand? InsertCommand
        {
            ...
            set
            {
                ...
                InternalAdapter.InsertCommand = value is ProfiledDbCommand cmd
                    ? cmd.WrappedCommand
                    : value;
            }
        }
        ...
        public new IDbCommand? UpdateCommand
        {
            ...
            set
            {
                ...
                InternalAdapter.UpdateCommand = value is ProfiledDbCommand cmd
                    ? cmd.WrappedCommand
                    : value;
            }
        }
        ...
        public new IDbCommand? DeleteCommand
        {
            ...
            set
            {
                ...
                InternalAdapter.DeleteCommand = value is ProfiledDbCommand cmd
                    ? cmd.WrappedCommand
                    : value;
            }
        }
