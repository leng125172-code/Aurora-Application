...
namespace StackExchange.Profiling.Data
{
    ...
    public class ProfiledDbConnection : DbConnection
    {
        ...
        public override void Close()
        {
            ...
            if (
                miniProfiler?.IsActive != true
                || miniProfiler.Options?.TrackConnectionOpenClose == false
            )
            {
                _connection.Close();
                return;
        ...
        protected override DbCommand CreateDbCommand() =>
            CreateDbCommand(_connection.CreateCommand(), _profiler);
        ...
        private void StateChangeHandler(
            object sender,
            StateChangeEventArgs stateChangeEventArguments
        )
        {
