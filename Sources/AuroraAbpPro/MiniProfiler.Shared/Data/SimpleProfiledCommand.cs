...
namespace StackExchange.Profiling.Data
{
    ...
    public class SimpleProfiledCommand : IDbCommand
    {
        ...
        public int ExecuteNonQuery() =>
            ProfileWith(SqlExecuteType.NonQuery, _command.ExecuteNonQuery);

        /// <inheritdoc cref="IDbCommand.ExecuteReader()"/>
        public IDataReader ExecuteReader() =>
            ProfileWith(
                SqlExecuteType.Reader,
        ...
        public object? ExecuteScalar() =>
            ProfileWith(SqlExecuteType.Scalar, () => _command.ExecuteScalar());
        ...
        public IDbConnection? Connection
        {
            ...
            set
            {
                ...
                _command.Connection = value is SimpleProfiledConnection wrapped
                    ? wrapped.WrappedConnection
                    : value;
            }
        }
        ...
        public IDbTransaction? Transaction
        {
            ...
            {
                _transaction = value;
                _command.Transaction = value is SimpleProfiledTransaction wrapped
        ...
        [SuppressMessage(
            ...
            Justification = "Handled elsewhere."
        )]
