...
namespace StackExchange.Profiling.Data
{
    ...
    public class ProfiledDbProviderFactory : DbProviderFactory
    {
        ...
        [SuppressMessage(
            ...
            Justification = "This does not appear to be used anywhere, we need to refactor it."
        )]
        public static readonly ProfiledDbProviderFactory Instance = new();
...
#pragma warning restore CS8618
        ...
        public override DbConnectionStringBuilder? CreateConnectionStringBuilder() =>
            _factory.CreateConnectionStringBuilder();
        ...
        public override bool CanCreateDataSourceEnumerator =>
            _factory.CanCreateDataSourceEnumerator;
