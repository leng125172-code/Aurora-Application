...
namespace StackExchange.Profiling.SqlFormatters
{
    ...
    public class VerboseSqlServerFormatter : SqlServerFormatter, IAdvancedSqlFormatter
    {
        ...
        public override string FormatSql(
            string commandText,
        ...
        )
        {
            ...
            if (command != null && IncludeMetaData)
            {
                buffer
                    .Append("-- Command Type: ")
                    .Append(command.CommandType.ToString())
                    .Append('\n');
                ...
                {
                    buffer
                        .Append("-- Command Transaction Iso Level: ")
                        .Append(command.Transaction.IsolationLevel.ToString())
                        .Append('\n');
                }
                if (System.Transactions.Transaction.Current != null)
                {
                    ...
                    buffer
                        .Append("-- Transaction Scope Iso Level: ")
                        .Append(System.Transactions.Transaction.Current.IsolationLevel.ToString())
                        .Append('\n');
                }
