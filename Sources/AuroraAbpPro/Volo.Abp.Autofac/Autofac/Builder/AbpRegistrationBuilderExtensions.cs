...
public static class AbpRegistrationBuilderExtensions
{
        ...
        where TActivatorData : ReflectionActivatorData
    {
        ...
        {
            if (
                serviceRegistrationActionList.IsClassInterceptorsDisabled
                || serviceRegistrationActionList.DisabledClassInterceptorsSelectors.Any(selector =>
                    selector.Predicate(serviceType)
                )
            )
            {
                return registrationBuilder;
