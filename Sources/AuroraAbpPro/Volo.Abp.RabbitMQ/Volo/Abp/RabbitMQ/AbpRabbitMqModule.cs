...
public class AbpRabbitMqModule : AbpModule
{
    ...
    {
        await context.ServiceProvider.GetRequiredService<IChannelPool>().DisposeAsync();

        await context.ServiceProvider.GetRequiredService<IConnectionPool>().DisposeAsync();
    }
}
