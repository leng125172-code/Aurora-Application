...
{
    public class AuroraCVDbMigrationService : ITransientDependency
    {
        public ILogger<AuroraCVDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IAuroraCVDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public AuroraCVDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IAuroraCVDbSchemaMigrator> dbSchemaMigrators,
        ...
        )
        {
            ...
            Logger = NullLogger<AuroraCVDbMigrationService>.Instance;
        }
            ...
            while (Directory.GetParent(currentDirectory.FullName) != null)
            {
                ...
                if (
                    Directory
                        ...
                        .FirstOrDefault(f => f.EndsWith(".slnx")) != null
                )
                {
