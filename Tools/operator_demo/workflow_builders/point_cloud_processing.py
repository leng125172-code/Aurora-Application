...
def build_3d_point_cloud_processing_graph(point_cloud_path):
    id_start = new_uuid()
    id_read = new_uuid()
    ...
    nodes = [
        ...
        node(
            ...
            "平面度检测",
            make_properties(
                params={"distanceThreshold": 0.1, "imageResolution": IMAGE_RESOLUTION},
                param_sources={
                    "distanceThreshold": "literal",
                ...
                output_bindings={
                    ...
                    "stats_json": "flatness_stats",
                    "flatness": "flatness_value",
                    "max_absolute_distance": "max_absolute_distance",
                    "is_ok": "flatness_ok",
                },
                output_sources={
                    ...
                    "stats_json": "variable",
                    "flatness": "variable",
                    "max_absolute_distance": "variable",
                    "is_ok": "variable",
                },
            ),
        ),
        node(
            ...
            make_properties(
                ...
                output_bindings={
                    ...
                    "fitting_error_value": "line_rmse",
                    "angle_degrees": "line_angle_degrees",
                    "is_ok": "line_ok",
                    "result_json": "line_result",
                },
                output_sources={
                    ...
                    "fitting_error_value": "variable",
                    "angle_degrees": "variable",
                    "is_ok": "variable",
        ...
        node(
            ...
            make_properties(
                ...
                output_bindings={
                    ...
                    "fitting_error_value": "circle_rmse",
                    "radius": "circle_radius",
                    "is_ok": "circle_ok",
                    "result_json": "circle_result",
                },
                output_sources={
        ...
        node(
            ...
            make_properties(
                input_bindings={
                    ...
                    "line_ok": "line_ok",
                    "circle_ok": "circle_ok",
                    "flatness_result": "flatness_stats",
                    "line_result": "line_result",
                    "circle_result": "circle_result",
                },
                input_sources={
                    "flatness_ok": "variable",
                    "line_ok": "variable",
                    "circle_ok": "variable",
        ...
        node(
            ...
            make_properties(
                input_bindings={
                    ...
                    "flatnessHeatmapBlobName": "flatness_heatmap_blob_name",
                    "flatnessHeatmapUrl": "flatness_heatmap_url",
                    "isOk": "inspection_ok",
                    "inspectionResult": "inspection_result",
                    "flatness": "flatness_value",
                    "maxAbsoluteDistance": "max_absolute_distance",
                    "lineAngleDegrees": "line_angle_degrees",
                    "lineRmse": "line_rmse",
                    "circleRadius": "circle_radius",
                    "circleRmse": "circle_rmse",
                    "planeArea": "plane_area",
                    "planeAreaResult": "plane_area_result",
                },
                input_sources={
                    "pointCloudUrl": "variable",
                    "imageBlobName": "variable",
                    "imageUrl": "variable",
                    "flatnessHeatmapBlobName": "variable",
                    "flatnessHeatmapUrl": "variable",
                    "isOk": "variable",
                    "inspectionResult": "variable",
                    "flatness": "variable",
                    "maxAbsoluteDistance": "variable",
                    "lineAngleDegrees": "variable",
                    "lineRmse": "variable",
                    "circleRadius": "variable",
                    "circleRmse": "variable",
                    "planeArea": "variable",
                    "planeAreaResult": "variable",
                },
            ),
        ),
    ]
...
def build_split_3d_point_cloud_graphs(point_cloud_path):
    ...
    line_angle = focused_graph(
        ...
        {
            "roiImageUrl": "image_download_url",
            "angleDegrees": "line_angle_degrees",
            "rmse": "line_rmse",
            "isOk": "line_ok",
            "result": "line_result",
        },
